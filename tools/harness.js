...
globalThis.__ENGINE__ = {
  ...
  recordPromiseTraining, recordPromisePositionChange, promisePenalty, archiveRecord, rememberCoach, promiseHubItems, recordChaseHubItems, deriveRivalries, rivalOf, rivalryGameFor, isRivalryGame, rivalryHubItems, settleRivalryGame, rivalrySeriesText, seasonExpectation, ensureAdminState, adminSeasonReview, reviewControlledProgram, adminHubItems, adminConfidenceLabel, nilBudgetFor, nilRemaining, nilDealCost, nilDealActive, nilRetentionRelief, signNilDeal, cancelNilDeal, ensureNilState, resetNilSeason, careerChronologyHTML, RECORD_CATS,
