...
globalThis.__ENGINE__ = {
  ...
  gameSim, detailedDriveCount, detailedGame, simulateUserDetailed, watchUserDetailed, gameBoxHTML, gameSummaryHTML, gameDrivesHTML, gameWatchHTML, renderGameArchive, showGameCenter, simWeek, simSeason, simConferenceChampionships, simPlayoff, runOffseason,
  ...
  recordPromiseTraining, recordPromisePositionChange, promisePenalty, archiveRecord, rememberCoach, promiseHubItems, recordChaseHubItems, deriveRivalries, rivalOf, rivalryGameFor, isRivalryGame, rivalryHubItems, settleRivalryGame, rivalrySeriesText, seasonExpectation, ensureAdminState, adminSeasonReview, reviewControlledProgram, adminHubItems, adminConfidenceLabel, nilBudgetFor, nilRemaining, nilDealCost, nilDealActive, nilRetentionRelief, signNilDeal, careerTotals, careerWinPct, hiringCeiling, hiringMarket, closeTenure, acceptPost, careerSummaryText, tenureRecord, careerHubItems, simBowls, bowlField, seedField, buildSigningDay, signingDayOdds, ensureAcademics, academicTarget, allKnownCoaches, coachingTree, treeHeadCoaches, creditCoachingTree, coachTreeHubItems, academicRisk, academicallyIneligible, academicStatusText, advanceAcademics, academicDecision, applyAcademicDecision, academicHubItems, gameAvailable, signingDayPending, revealNextSigning, revealAllSigning, signingDayHubItems, decommitRecruit, bowlEligible, bowlHubItems, fanSupportTarget, updateFanSupport, homeFieldFor, cancelNilDeal, ensureNilState, resetNilSeason, careerChronologyHTML, RECORD_CATS,
