...
// / sports-presentation.js / recruit-presentation.js / next-action.js / team-logo-coverage.js /
...
console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) from renderer-v1.js + storage.js + rng.js + escape.js + app.js + styles.css + visual-identity.css + team-branding.css + conference-branding.css + sports-presentation.css + sports-layout.css + recruit-presentation.css + polish.css + body.html + program-branding.js + conference-branding.js + visual-identity.js + sports-presentation.js + recruit-presentation.js + next-action.js + team-logo-coverage.js + program-color-coverage.js`);
