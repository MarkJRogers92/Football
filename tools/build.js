...
const engineExtensionFiles=['staff-scouting-core.js','scouting-actions.js','scouting-trail.js','recruiting-filters.js','recruit-compare.js','recruiting-shortlist.js','scouting-receipts.js','staff-scouting-ui.js','recruiting-history.js','development-tendencies.js','recruiting-battles.js','development-plans.js','game-engine-v2-lab-integration.js','game-engine-v2-record-state.js','game-engine-v2-record-run.js','game-engine-v2-record-ui.js','game-engine-v2-cutover.js','game-engine-v2-postseason.js','career-history-fix.js','game-engine-v2-presentation.js','game-engine-v2-gameday-prep.js','game-engine-v2-gameday-record.js','game-engine-v2-gameday-ui.js','game-engine-v2-gameday-prep-bridge.js','game-engine-v2-matchup-ui.js','game-engine-v2-gameday-soak.js','weekly-coaching-loop.js','weekly-personnel-decisions.js'];
...
const out = process.argv[2] || 'index.html';fs.writeFileSync(path.join(root, out), html);console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) with Game Engine 2 foundation, interactive coaching decisions, matchup intelligence, v0.10.2 opponent scouting, weekly preparation and selective personnel decisions, archived game-plan feedback, permanent Game Day recording and season soak coverage, calibrated matchup simulation, real-player attribution, transactional rollback, release Game Day presentation, scouting, recruiting intelligence and development systems`);
