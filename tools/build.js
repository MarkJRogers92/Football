...
console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) from renderer-v1.js + app.js + storage.js + styles.css + visual-identity.css + team-branding.css + sports-presentation.css + sports-layout.css + recruit-presentation.css + body.html + visual-identity.js + sports-presentation.js + recruit-presentation.js`);
