...
const engineExtensionFiles=['scouting-actions.js','scouting-trail.js','recruiting-filters.js','recruit-compare.js','recruiting-shortlist.js','scouting-receipts.js','recruiting-history.js','development-tendencies.js'];
...
const out = process.argv[2] || 'index.html';fs.writeFileSync(path.join(root, out), html);console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) with scouting, evaluation trail, recruiting filters, recruit compare, staff shortlist, delayed scouting receipts, recruiting history and observed development tendency extensions`);
