...
// / recruit-presentation.css / scouting-actions.css / conference-branding.css / program-branding.js /
// / visual-identity.js / sports-presentation.js / recruit-presentation.js / next-action.js /
// / scouting-actions.js / team-logo-coverage.js / program-color-coverage.js / body.html /
// / storage.js / rng.js / escape.js / portraits/renderer-v1.js stay the single source of truth and
// the deployable artifact is always a byte-for-byte function of them.
const fs = require('fs');
...
const appSource=injectEngineExtension(baseAppSource,'scouting-actions.js');
...
console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) with scouting-actions.js injected into app.js plus next-action.js and presentation assets`);
