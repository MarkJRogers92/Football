...
const out = process.argv[2] || 'index.html';fs.writeFileSync(path.join(root, out), html);console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) with Game Engine 2 foundation, interactive coaching decisions, matchup intelligence, v0.10.2 opponent scouting and weekly preparation, archived game-plan feedback, permanent Game Day recording and season soak coverage, calibrated matchup simulation, real-player attribution, transactional rollback, release Game Day presentation, scouting, recruiting intelligence and development systems`);
