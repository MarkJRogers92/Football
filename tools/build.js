...
const engineExtensionFiles=['scouting-actions.js','recruit-compare.js','recruiting-shortlist.js','scouting-receipts.js','recruiting-history.js','development-tendencies.js'];
...
const out = process.argv[2] || 'index.html';fs.writeFileSync(path.join(root, out), html);console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) with scouting, recruit compare, staff shortlist, delayed scouting receipts, recruiting history and observed development tendency extensions`);
