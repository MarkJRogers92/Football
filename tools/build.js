...
const out = process.argv[2] || 'index.html';fs.writeFileSync(path.join(root, out), html);console.log(`built ${out} (${(html.length / 1024).toFixed(0)} KB) with Game Engine 2 foundation, deterministic Game Day decisions, paused/resumable Game Day runner, cloned weekly recovery preparation, permanent Interactive Game Day recording, calibrated matchup simulation, real-player attribution, transactional rollback, Detailed Game and postseason v2 cutover, release Game Day presentation, scouting, staff evaluation identity, recruiting intelligence and development systems`);
