...
let queued=false;function run(){queued=false;dashboard();playerHero();matchup();score()}function queue(){if(queued)return;queued=true;(window.requestAnimationFrame||setTimeout)(run)}
