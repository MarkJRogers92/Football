...
const STYLE_TRAITS={
 'Rhythm Distributor':['technique','iq','composure'],'Field Architect':['iq','technique','composure'],'Off-Script Creator':['speed','versatility','composure'],'Vertical Hunter':['power','technique','composure'],'Power Creator':['power','speed','durability'],'Run-First Weapon':['speed','power','versatility'],'Toolsy Project':['speed','technique','power'],'Backyard Magician':['versatility','composure','speed'],
 'Gap Hammer':['power','durability','technique'],'Space Cutter':['speed','versatility','iq'],'Contact Glider':['power','composure','durability'],'Third-Down Weapon':['technique','versatility','iq'],'One-Cut Burner':['speed','technique','iq'],'Patient Slasher':['iq','technique','composure'],
 'Boundary Bully':['power','technique','composure'],'Space Hunter':['speed','iq','versatility'],'Route Sculptor':['technique','iq','composure'],'Vertical Glider':['speed','power','composure'],'Catch-Point Ace':['technique','power','composure'],'YAC Creator':['speed','power','versatility'],'Motion Weapon':['versatility','speed','iq'],
 'Seam Hunter':['speed','technique','iq'],'Inline Mauler':['power','durability','technique'],'Move Chesspiece':['versatility','technique','iq'],'Red-Zone Tower':['power','technique','composure'],'Backfield Hybrid':['versatility','power','iq'],
 'Island Protector':['technique','iq','composure'],'Movement Tackle':['speed','technique','versatility'],'Power Edge':['power','durability','technique'],'Long-Frame Project':['power','speed','versatility'],'Drive Blocker':['power','technique','durability'],'Phone-Booth Anchor':['power','durability','composure'],'Pulling Guard':['speed','versatility','technique'],'Interior Technician':['technique','iq','composure'],'Protection Quarterback':['iq','technique','composure'],'Leverage Center':['technique','power','iq'],'Movement Pivot':['speed','versatility','technique'],'Power Pivot':['power','durability','technique'],
 'Pocket Wrecker':['technique','speed','power'],'Speed Bender':['speed','technique','versatility'],'Power Setter':['power','durability','technique'],'Chaos Rusher':['versatility','speed','composure'],'Run-Side Anchor':['power','iq','durability'],'Pocket Crusher':['power','technique','composure'],'Gap Eater':['power','durability','iq'],'Penetrator':['speed','technique','composure'],'Two-Gap Anchor':['power','iq','durability'],'Interior Disruptor':['technique','power','speed'],
 'Range Hunter':['speed','iq','technique'],'Box Enforcer':['power','durability','composure'],'Coverage Rover':['versatility','speed','iq'],'Pressure Backer':['speed','power','technique'],'Traffic Director':['iq','composure','technique'],'Mirror Corner':['technique','speed','composure'],'Press Eraser':['power','technique','composure'],'Ball Hunter':['iq','technique','speed'],'Boundary Fighter':['power','durability','technique'],'Slot Shadow':['speed','versatility','iq'],'Centerfielder':['speed','iq','composure'],'Box Hammer':['power','durability','composure'],'Coverage Eraser':['technique','speed','iq'],'Hybrid Rover':['versatility','speed','power'],'Trigger Safety':['iq','speed','composure'],
 'Pressure Leg':['composure','power','technique'],'Range Kicker':['power','technique','durability'],'Placement Specialist':['technique','iq','composure'],'Field Flipper':['power','technique','durability'],'Hang-Time Specialist':['technique','power','composure'],'Directional Punter':['technique','iq','composure']
};
const ARCHETYPE_LABELS={
 'Vertical Hunter':'Deep-Ball Hunter','Power Creator':'Power Dual-Threat','Toolsy Project':'Traits Project','Contact Glider':'Contact-Balance Back','Space Hunter':'Space Separator','Vertical Glider':'Vertical Burner','Move Chesspiece':'Move Weapon','Power Edge':'Power Tackle','Protection Quarterback':'Line General','Pressure Leg':'Pressure Kicker'
};
const ARCHETYPE_DESCRIPTIONS={
 'Rhythm Distributor':'Timing passer who wins with accuracy, processing and composure. Gets the ball out and keeps the offense on schedule.','Field Architect':'Cerebral pocket quarterback who diagnoses coverage and controls structure.','Off-Script Creator':'Mobile passer who creates after the original play breaks down.','Vertical Hunter':'Aggressive downfield passer built around arm strength and vertical shots.','Power Creator':'Strong runner-passer whose physicality creates offense inside and outside structure.','Run-First Weapon':'Quarterback whose legs are a primary offensive weapon rather than an emergency option.','Toolsy Project':'High-end tools with significant technical development still required.','Backyard Magician':'Improvisational creator whose versatility and composure generate unconventional plays.',
 'Gap Hammer':'Downhill runner built to attack designed lanes and finish through contact.','Space Cutter':'Quick-space runner who turns leverage and angles into chunk plays.','Contact Glider':'Runner who stays upright through glancing contact and consistently falls forward.','Third-Down Weapon':'Receiving and pass-down specialist with route and space versatility.','One-Cut Burner':'Fast runner who plants once and explodes vertically.','Patient Slasher':'Vision-based runner who waits for blocks and attacks the correct crease.',
 'Boundary Bully':'Physical outside receiver who wins through contact and at the catch point.','Space Hunter':'Finds leverage and open grass; thrives against zones and off coverage.','Route Sculptor':'Technical route runner who creates separation with timing and precision.','Vertical Glider':'Long-speed threat designed to stretch coverage.','Catch-Point Ace':'Wins contested catches and difficult throws.','YAC Creator':'Turns ordinary completions into explosive plays after the catch.','Motion Weapon':'Versatile receiver used through motion, alignment changes and manufactured touches.',
 'Seam Hunter':'Vertical receiving tight end who attacks linebackers and safeties.','Inline Mauler':'Traditional attached tight end whose blocking value drives his role.','Move Chesspiece':'Flexible receiver who aligns in the slot, wing or detached formations.','Red-Zone Tower':'Size and ball-skill specialist who becomes most valuable near the goal line.','Backfield Hybrid':'H-back and fullback-style player who moves between backfield and tight-end responsibilities.',
 'Island Protector':'Pass-protection tackle trusted alone against premium rushers.','Movement Tackle':'Athletic tackle suited for space, movement and wide run concepts.','Power Edge':'Strength-first tackle who wins through anchor and displacement.','Long-Frame Project':'Prototype body with traits that require technical development.','Drive Blocker':'Displacement blocker built for downhill run concepts.','Phone-Booth Anchor':'Compact interior protector who wins in tight space.','Pulling Guard':'Athletic guard who is most valuable on movement assignments.','Interior Technician':'Precision blocker with hand use, awareness and consistency.','Protection Quarterback':'Smart center who organizes protection and wins through recognition.','Leverage Center':'Technique and power center who wins through pad level and positioning.','Movement Pivot':'Athletic center designed for reach blocks, space and movement.','Power Pivot':'Strength-heavy center for physical interior run games.',
 'Pocket Wrecker':'Complete pass rusher with enough speed, technique and power to collapse protections.','Speed Bender':'Outside rusher who wins with first-step burst and cornering ability.','Power Setter':'Strength-first edge who can rush and adds substantial edge-setting value.','Chaos Rusher':'Unpredictable, high-variance athlete who creates pressure from multiple paths.','Run-Side Anchor':'Edge defender whose primary value is controlling the run and maintaining structure.','Pocket Crusher':'Interior power rusher who compresses the pocket.','Gap Eater':'Space-eating interior defender built to absorb blocks and control the run.','Penetrator':'Quick upfield tackle who attacks gaps before blocks develop.','Two-Gap Anchor':'Heavy interior defender who reads and controls multiple gaps.','Interior Disruptor':'Balanced interior playmaker capable of pressure and backfield disruption.',
 'Range Hunter':'Pursuit linebacker built to cover ground and finish plays.','Box Enforcer':'Physical downhill linebacker strongest against the run.','Coverage Rover':'Space linebacker used against backs, tight ends and underneath passing concepts.','Pressure Backer':'Blitz and rush-oriented linebacker who threatens the backfield.','Traffic Director':'Smart communicator who organizes the defense and consistently finds the football.','Mirror Corner':'Man-coverage technician who stays attached through route movement.','Press Eraser':'Physical press corner designed to disrupt receivers at the line.','Ball Hunter':'Aggressive playmaker who trades some conservatism for takeaways.','Boundary Fighter':'Physical outside corner who handles contact and run-support duties.','Slot Shadow':'Quick-processing nickel corner built to survive inside traffic.','Centerfielder':'Deep-range safety who closes space and hunts throws.','Box Hammer':'Physical safety whose strongest work happens near the line of scrimmage.','Coverage Eraser':'Versatile coverage safety who repairs mistakes and eliminates passing windows.','Hybrid Rover':'Multi-role safety capable of box, slot and deep assignments.','Trigger Safety':'Fast-processing safety who diagnoses quickly and attacks the play downhill.',
 'Pressure Leg':'Composure-driven kicker whose value increases in high-leverage attempts.','Range Kicker':'Power specialist capable of extending field-goal range.','Placement Specialist':'Accuracy and control kicker who prioritizes repeatable mechanics.','Field Flipper':'Distance-oriented punter who changes field position.','Hang-Time Specialist':'Control and power punter built to reduce return opportunities.','Directional Punter':'Placement-focused punter who prioritizes location and control.'
};
const ARCHETYPE_META=Object.fromEntries(Object.values(STYLES).flat().map(style=>[style,{display:ARCHETYPE_LABELS[style]||style,short:ARCHETYPE_DESCRIPTIONS[style]||'Player identity.',strengths:[...(STYLE_TRAITS[style]||[])]}]));
function archetypeMeta(style){return ARCHETYPE_META[style]||{display:style||'Unknown archetype',short:'Player identity.',strengths:[...(STYLE_TRAITS[style]||[])]}}
function archetypeLabel(style){return archetypeMeta(style).display}
function archetypeDescription(style){return archetypeMeta(style).short}
function archetypePosition(style){return Object.keys(STYLES).find(pos=>STYLES[pos].includes(style))||''}
function archetypeChipHTML(style){return `<button type="button" class="archetype-chip" data-archetype="${style}">${archetypeLabel(style)}</button>`}
...
let schools=[],universe=null,developmentResultsPhase='',developmentResultsFilter='ALL',developmentResultsSort='jump';

let gameplayRng=null,gameplayRngUniverse=null;
function freshGameplaySeed(){const words=new Uint32Array(2),c=globalThis.crypto;if(c?.getRandomValues){c.getRandomValues(words);return `${words[0].toString(16).padStart(8,'0')}${words[1].toString(16).padStart(8,'0')}`}return `local-${Date.now().toString(36)}`}
function legacyGameplaySeed(u){return `legacy:${u?.year||0}:${u?.week||0}:${u?.teams?.[0]?.id||u?.teams?.[0]?.name||'dynasty'}`}
function activateGameplayRng(saved,owner=null){gameplayRng=DynastyRng.create(saved??freshGameplaySeed());gameplayRngUniverse=owner;return gameplayRng}
function ensureGameplayRng(){if(universe&&gameplayRngUniverse!==universe)activateGameplayRng(universe.rng??legacyGameplaySeed(universe),universe);else if(!gameplayRng)activateGameplayRng();return gameplayRng}
function syncGameplayRng(u=universe){if(u&&gameplayRng&&(!gameplayRngUniverse||gameplayRngUniverse===u)){u.rng=gameplayRng.snapshot();gameplayRngUniverse=u}return u?.rng||null}
function gameplayRandom(){return ensureGameplayRng().next()}
const rng=(a,b)=>gameplayRandom()*(b-a)+a, gi=(a,b)=>Math.floor(rng(a,b+1)), pick=a=>a[gi(0,a.length-1)], clamp=(v,a,b)=>Math.max(a,Math.min(b,v));
function gauss(){let u=0,v=0;while(!u)u=gameplayRandom();while(!v)v=gameplayRandom();return Math.sqrt(-2*Math.log(u))*Math.cos(2*Math.PI*v)}
...
function styleForTraits(pos,traits,jitter=2.5){return (STYLES[pos]||[]).map((style,index)=>{const keys=STYLE_TRAITS[style]||[],score=keys.reduce((n,key,i)=>n+(traits[key]??traits.trueNow??60)*([.5,.3,.2][i]||0),0)+(jitter?gauss()*jitter:0);return{style,score,index}}).sort((a,b)=>b.score-a.score||a.index-b.index)[0]?.style||pick(STYLES[pos])}
function styleDescription(p){const names={speed:'speed',power:'power',technique:'technique',iq:'processing',composure:'composure',durability:'durability',versatility:'versatility'},traits=(STYLE_TRAITS[p.style]||[]).map(x=>names[x]||x),u=STYLE_USAGE[p.style]||{};let use='';if(p.pos==='QB')use=(QB_RUSH_STYLE_WEIGHT[p.style]??.055)>=.09?' Designed runs and scrambles are part of his usage.':' His rushing usage is limited unless mobility and scheme create it.';else if(['RB','WR','TE'].includes(p.pos)){if((u.target||1)>=1.15)use=' The role model increases his receiving opportunity.';else if((u.carry||1)>=1.1)use=' The role model increases his carry share and limits manufactured targets.'}else if(['EDGE','DT','LB'].includes(p.pos))use=(u.rush||1)>(u.tackle||1)?' His production leans toward pressure.':' His production leans toward run stops and tackles.';else if(['CB','S'].includes(p.pos))use=(u.takeaway||1)>=1.15?' His production leans toward takeaways.':' His production leans toward coverage or tackling.';else if(['OT','OG','C'].includes(p.pos))use=' The protection model uses this identity when assigning pressures and sacks allowed.';else if(p.pos==='K')use=' Technique and power drive accuracy/range; composure matters most on pressure attempts.';else if(p.pos==='P')use=' Power and technique drive punt distance. Hang time and direction are not tracked.';return `Archetype emphasis: ${traits.join(', ')}.${use}`}
...
function hasPlayerTraits(s){return PLAYER_TRAITS.every(k=>Number.isFinite(s?.[k]))}
function playerTraitFields(s){return Object.fromEntries(PLAYER_TRAITS.filter(k=>Number.isFinite(s?.[k])).map(k=>[k,s[k]]))}
function scoutingTruth(s,d,recruit=false){if(d[0]==='upside')return s.upside??s.scoutUp??s.trueNow;const weights=d[2];if(recruit&&!hasPlayerTraits(s))return clamp(Math.round((s.trueNow??s.scout)+scoutHash(s,d[0],'profile')*7),25,99);let n=0,w=0;for(const [k,x] of Object.entries(weights)){n+=(s[k]??s.trueNow)*x;w+=x}return clamp(Math.round(n/(w||1)),20,99)}
...
function scoutingPanelHTML(s,t,recruit=false){let rows=scoutingDomainView(s,t,recruit),legacy=recruit&&!hasPlayerTraits(s)?'<div class="small muted">Legacy evaluation: position traits will be established when this recruit enrolls.</div>':'';return `<h3 class="scouting-heading">Scouting Intelligence</h3><div class="profile-note">${archetypeChipHTML(s.style)} · ${archetypeDescription(s.style)}</div>${legacy}<div class="scouting-domains">${rows.map(x=>`<div class="scouting-domain"><span>${x.label}</span><strong>${x.low}–${x.high}</strong><small>${scoutingConfidenceLabel(x.confidence)} confidence</small></div>`).join('')}</div>`}
...
function inheritRecruitTraits(p){if(p.recruitTraitsInherited||!universe?.recruits?.length)return false;const r=universe.recruits.find(r=>r.name===p.name&&r.pos===p.pos&&r.portraitSeed===p.portraitSeed&&hasPlayerTraits(r));if(!r)return false;const inherited=playerTraitFields(r);for(const key of ['work','dev'])if(Number.isFinite(r[key]))inherited[key]=r[key];Object.assign(p,inherited);p.recruitTraitsInherited=true;return true}
function ensurePlayerDevelopment(p,t){inheritRecruitTraits(p);ensurePortrait(p);
 p.growthProfile??=pick(GROWTH_PROFILE_KEYS);p.devFraction??=0;p.growthVolatility??=clamp(Math.round(45+gauss()*22),10,95);p.framePotential??=clamp(Math.round(58+gauss()*20),10,98);p.speedRetention??=clamp(Math.round(70+gauss()*16),20,99);p.heightGrowthRemaining??=(eligibilityBase(p)===0&&gameplayRandom()<.24?1:0);p.trainingFocus??='Balanced';p.positionFamiliarity??={[p.pos]:100};p.positionFamiliarity[p.pos]??=100;p.formerPositions??=[];p.scoutConfidence??=clamp(Math.round(38+eligibilityBase(p)*13+(t?staffEval(t)*.18:12)+gauss()*5),28,94);p.lastDevelopmentDelta??=0;p.lastPhysicalChange??='';p.campGrade??=null;p.campHistory??=[];normalizeScoutingRecord(p);
}
...
function applyPhysicalGrowth(p,t){ensurePlayerDevelopment(p,t);let oldH=p.height,oldW=p.weight,elig=eligibilityBase(p),skill=['QB','RB','WR','CB','S','K','P'].includes(p.pos),line=['OT','OG','C','DT'].includes(p.pos);let baseGain=(line?rng(4,12):skill?rng(0,5):rng(2,8))*(p.framePotential/75)*(elig===0?1.15:elig===1?1:.65);if(t.trainingFocus==='Strength & Mass')baseGain*=1.35;if(t.trainingFocus==='Speed & Explosion')baseGain*=.65;let gain=Math.max(0,Math.round(baseGain+gauss()*1.5));p.weight=clamp(p.weight+gain,BODY[p.pos]?.[1]?.[0]||150,(BODY[p.pos]?.[1]?.[1]||360)+15);if(p.heightGrowthRemaining>0&&elig===0&&gameplayRandom()<.55){p.height+=1;p.heightGrowthRemaining=0}let excess=Math.max(0,gain-5),lossChance=excess*(100-p.speedRetention)/260;if(gameplayRandom()<lossChance)p.speed=clamp(p.speed-gi(1,2),20,99);p.lastPhysicalChange=`${p.height>oldH?'+1 in, ':''}${p.weight-oldW>=0?'+':''}${p.weight-oldW} lb`}
function applyDevelopmentPhase(p,t,phase){ensurePlayerDevelopment(p,t);recordPromiseTraining(p,phase);let curve=growthFactor(p),staff=OFF_POS.has(p.pos)?t.staff.OC.development:t.staff.DC.development,base=(p.dev*.27+p.work*.22+p.coach*.10+t.development*.16+t.facilities*.09+t.staff.SC.development*.08+staff*.08-52)/9,vol=phase==='spring'?1.45:.85,raw=base*curve*(phase==='spring'?1:.5)+gauss()*vol*(.65+p.growthVolatility/150),carried=(p.devFraction||0)+raw,delta=clamp(Math.round(carried),-3,phase==='spring'?7:4),ceiling=p.upside+(p.growthProfile==='volatile'?2:0);p.devFraction=clamp(carried-delta,-2.5,2.5);p.trueNow=clamp(p.trueNow+delta,30,Math.min(99,ceiling));let mods=trainingAttrBoost(p,t.trainingFocus,p.trainingFocus,phase);for(const k of Object.keys(mods)){let chance=clamp(.35+mods[k]*.28+(p.work-50)/180,.15,.92);if(gameplayRandom()<chance)p[k]=clamp(Math.round((p[k]||p.trueNow)+Math.max(0,mods[k]+gauss()*.6)),20,99)}if(p.trainingFocus==='Rehab'){p.health=clamp((p.health??100)+gi(5,12),40,100);p.wear=clamp((p.wear||0)-gi(8,18),0,100)}let famGain=phase==='spring'?gi(8,18):gi(5,12);if(p.trainingFocus==='Position Transition'||t.trainingFocus==='Scheme Installation')famGain+=gi(4,9);p.positionFamiliarity[p.pos]=clamp(familiarity(p,p.pos)+famGain,0,100);p.scoutConfidence=clamp(p.scoutConfidence+(phase==='spring'?gi(8,15):gi(6,12))+((p.stats?.games||0)>6?3:0),25,98);let err=gauss()*Math.max(1,(100-p.scoutConfidence)/12);p.perceived=clamp(Math.round(p.trueNow+err),30,99);p.perceivedUpside=clamp(Math.round(p.upside+gauss()*Math.max(1,(100-p.scoutConfidence)/10)),p.perceived,99);p.lastDevelopmentDelta=(p.lastDevelopmentDelta||0)+delta;if(phase==='spring')applyPhysicalGrowth(p,t);return delta}
function developmentSnapshot(p){return{trueNow:p.trueNow,perceived:p.perceived,perceivedUpside:p.perceivedUpside,speed:p.speed,power:p.power,technique:p.technique,iq:p.iq,composure:p.composure,durability:p.durability,versatility:p.versatility,height:p.height,weight:p.weight,familiarity:familiarity(p,p.pos),scoutConfidence:p.scoutConfidence,health:p.health,wear:p.wear}}
function developmentDelta(before,after){const change=key=>(after[key]??0)-(before[key]??0);return{overallDelta:change('trueNow'),perceivedDelta:change('perceived'),upsideEstimateDelta:change('perceivedUpside'),attr:Object.fromEntries(PLAYER_TRAITS.map(key=>[key,change(key)])),weightDelta:change('weight'),heightDelta:change('height'),familiarityDelta:change('familiarity'),confidenceDelta:change('scoutConfidence'),healthDelta:change('health'),wearDelta:change('wear')}}
function developmentResult(p,t,phase,before,extra={}){const after=developmentSnapshot(p),delta=developmentDelta(before,after);return{id:p.id,name:p.name,pos:p.pos,phase:phase.toUpperCase(),delta:delta.overallDelta,...delta,overallAfter:after.trueNow,perceivedAfter:after.perceived,upsideEstimateAfter:after.perceivedUpside,attrAfter:Object.fromEntries(PLAYER_TRAITS.map(key=>[key,after[key]])),heightAfter:after.height,weightAfter:after.weight,familiarityAfter:after.familiarity,confidenceAfter:after.scoutConfidence,healthAfter:after.health,wearAfter:after.wear,physical:p.lastPhysicalChange||'',focus:p.trainingFocus||'Balanced',teamFocus:t.trainingFocus||'Balanced',...extra}}
function developmentTeamSummary(report=[]){return{players:report.length,averageOverall:report.length?Math.round(avg(report.map(x=>x.overallDelta))*10)/10:0,improved:report.filter(x=>x.overallDelta>0).length,declined:report.filter(x=>x.overallDelta<0).length,biggestRise:Math.max(0,...report.map(x=>x.overallDelta)),totalWeight:report.reduce((n,x)=>n+x.weightDelta,0)}}
function developmentGroupSummary(report=[]){return Object.values(report.reduce((out,x)=>{const g=out[x.pos]??={pos:x.pos,players:0,totalOverall:0,improved:0};g.players++;g.totalOverall+=x.overallDelta;if(x.overallDelta>0)g.improved++;return out},{})).map(g=>({...g,averageOverall:Math.round(g.totalOverall/g.players*10)/10})).sort((a,b)=>b.averageOverall-a.averageOverall||a.pos.localeCompare(b.pos))}
function developmentFocusSummary(report=[]){const teamFocus=report[0]?.teamFocus||'Balanced',targets=Object.keys(TEAM_TRAINING[teamFocus]?.attrs||{});return{teamFocus,targets:targets.map(key=>({key,improved:report.filter(x=>(x.attr?.[key]||0)>0).length,average:report.length?Math.round(avg(report.map(x=>x.attr?.[key]||0))*10)/10:0}))}}
function developmentMovementDistribution(report=[]){const counts={};for(const x of report)counts[x.overallDelta]=(counts[x.overallDelta]||0)+1;return Object.entries(counts).map(([delta,count])=>({delta:+delta,count})).sort((a,b)=>b.delta-a.delta)}
function developmentResultDetailHTML(x,p){if(!x)return'<div class="muted">Select a player result for details.</div>';const traitNames={speed:'Speed',power:'Power',technique:'Technique',iq:'Processing',composure:'Composure',durability:'Durability',versatility:'Versatility'},signed=n=>`${n>0?'+':''}${n}`,attrs=PLAYER_TRAITS.map(key=>{const after=x.attrAfter?.[key]??p?.[key]??0,before=after-(x.attr?.[key]||0);return `<div class="development-attribute"><span>${traitNames[key]}</span><span>${before} <b aria-hidden="true">→</b> ${after}</span><strong class="${x.attr?.[key]>0?'dev-rise':x.attr?.[key]<0?'dev-fall':'dev-flat'}">${signed(x.attr?.[key]||0)}</strong></div>`}).join('');return `<div class="development-detail-head"><div><div class="eyebrow">${x.phase} RESULT</div><h3>${x.name}</h3><div class="muted">${x.pos}${p?.style?` · ${archetypeLabel(p.style)}`:''}</div></div><div class="development-overall"><span>OVERALL</span><strong>${x.overallAfter-x.overallDelta} → ${x.overallAfter}</strong><b class="${x.overallDelta>0?'dev-rise':x.overallDelta<0?'dev-fall':'dev-flat'}">${signed(x.overallDelta)}</b></div></div><div class="development-attributes">${attrs}</div><div class="development-detail-grid"><div><span>Physical</span><strong>${x.heightAfter-x.heightDelta===x.heightAfter?heightStr(x.heightAfter):`${heightStr(x.heightAfter-x.heightDelta)} → ${heightStr(x.heightAfter)}`} · ${x.weightAfter-x.weightDelta} → ${x.weightAfter} lb</strong></div><div><span>Position familiarity</span><strong>${x.familiarityAfter-x.familiarityDelta}% → ${x.familiarityAfter}%</strong></div><div><span>Staff confidence</span><strong>${x.confidenceAfter-x.confidenceDelta}% → ${x.confidenceAfter}%</strong></div><div><span>Training plan</span><strong>${x.teamFocus} · ${x.focus}</strong></div></div>`}
function developmentResultsHTML(report=[],t,filter='ALL',sort='jump'){if(!report.length)return'<div class="development-results-empty muted">Complete Spring Development or Fall Camp to generate a full results receipt.</div>';const summary=developmentTeamSummary(report),groups=developmentGroupSummary(report),focus=developmentFocusSummary(report),distribution=developmentMovementDistribution(report),maxCount=Math.max(1,...distribution.map(x=>x.count)),signed=n=>`${n>0?'+':''}${n}`,traits={speed:'Speed',power:'Power',technique:'Technique',iq:'Processing',composure:'Composure',durability:'Durability',versatility:'Versatility'};let rows=report.filter(x=>filter==='ALL'||x.pos===filter||filter==='IMPROVED'&&x.overallDelta>0||filter==='REGRESSED'&&x.overallDelta<0||filter==='PHYSICAL'&&(x.weightDelta||x.heightDelta));rows.sort(sort==='position'?(a,b)=>POS.indexOf(a.pos)-POS.indexOf(b.pos)||b.overallDelta-a.overallDelta:sort==='decline'?(a,b)=>a.overallDelta-b.overallDelta:(a,b)=>b.overallDelta-a.overallDelta);const first=rows[0]||report[0],movement=distribution.map(x=>`<div class="development-distribution-row"><span>${signed(x.delta)}</span><i style="--bar:${Math.round(x.count/maxCount*100)}%"></i><strong>${x.count}</strong></div>`).join(''),groupButtons=groups.map(g=>`<button type="button" data-development-filter="${g.pos}" class="${filter===g.pos?'active':''}"><span>${g.pos}</span><strong>${signed(g.averageOverall)}</strong></button>`).join(''),focusText=focus.targets.length?focus.targets.map(x=>`${traits[x.key]||x.key}: ${x.improved} improved · ${signed(x.average)} avg`).join('<br>'):'Balanced work across the roster';const table=rows.map(x=>{const p=t.roster.find(p=>p.id===x.id),gains=Object.entries(x.attr||{}).filter(([,n])=>n>0).sort((a,b)=>b[1]-a[1]).slice(0,3).map(([key,n])=>`${traits[key]||key} ${signed(n)}`).join(' · ')||'No attribute increase';return `<tr><td data-label="Player"><button type="button" class="player-button" data-development-result="${x.id}">${x.name}</button><div class="small muted">${p?eligibilityLabel(p):x.pos} · ${p?archetypeLabel(p.style):x.pos}</div></td><td data-label="OVR"><strong>${x.overallAfter-x.overallDelta} → ${x.overallAfter}</strong></td><td data-label="Change"><strong class="${x.overallDelta>0?'dev-rise':x.overallDelta<0?'dev-fall':'dev-flat'}">${signed(x.overallDelta)}</strong></td><td data-label="Attribute gains">${gains}</td><td data-label="Physical">${x.physical||'—'}</td><td data-label="Confidence">${signed(x.confidenceDelta)}</td><td data-label="Focus">${x.focus}</td></tr>`}).join('');return `<div class="development-results-hero"><div><div class="eyebrow">${report[0].phase} DEVELOPMENT</div><h3>${t.name} · ${universe.year}</h3><p>${report[0].phase==='SPRING'?'The major growth window: development, body maturation and staff evaluation.':'Final evaluation, camp grades and depth-chart competition.'}</p></div><div class="development-kpis"><div><span>Team growth</span><strong>${signed(summary.averageOverall)} avg</strong></div><div><span>Players improved</span><strong>${summary.improved}</strong></div><div><span>Big jumps</span><strong>${report.filter(x=>x.overallDelta>=5).length}</strong></div><div><span>Regressions</span><strong>${summary.declined}</strong></div><div><span>Total weight</span><strong>${signed(summary.totalWeight)} lb</strong></div></div></div><div class="development-results-grid"><section><h4>Player movement</h4><div class="development-distribution">${movement}</div></section><section><h4>Your development plan</h4><p><strong>Team focus: ${focus.teamFocus}</strong></p><p class="compact muted">Observed outcomes<br>${focusText}</p></section></div><div class="development-groups"><button type="button" data-development-filter="ALL" class="${filter==='ALL'?'active':''}"><span>ALL</span><strong>${report.length}</strong></button>${groupButtons}</div><div class="development-results-controls"><div><button type="button" data-development-filter="IMPROVED" class="${filter==='IMPROVED'?'active':''}">Improved</button><button type="button" data-development-filter="REGRESSED" class="${filter==='REGRESSED'?'active':''}">Regressed</button><button type="button" data-development-filter="PHYSICAL" class="${filter==='PHYSICAL'?'active':''}">Physical change</button></div><label>Sort <select id="developmentResultsSort"><option value="jump" ${sort==='jump'?'selected':''}>Biggest jump</option><option value="decline" ${sort==='decline'?'selected':''}>Biggest decline</option><option value="position" ${sort==='position'?'selected':''}>Position</option></select></label></div><div class="development-results-body"><div class="table-wrap"><table><thead><tr><th>Player</th><th>OVR</th><th>Change</th><th>Attribute gains</th><th>Physical</th><th>Confidence</th><th>Focus</th></tr></thead><tbody>${table}</tbody></table></div><aside id="developmentResultDetail">${developmentResultDetailHTML(first,t.roster.find(p=>p.id===first.id))}</aside></div>`}
...
const OFFSEASON_PHASES=['review','departures','signing','portal','spring','fall','preseason'];
function makeOffseasonState(year,phase='preseason',completed=[],reports={}){
 const safePhase=OFFSEASON_PHASES.includes(phase)?phase:'preseason';
 return {year,phase:safePhase,completed:[...new Set(completed)].filter(x=>OFFSEASON_PHASES.includes(x)),reports:reports&&typeof reports==='object'&&!Array.isArray(reports)?reports:{}};
}
function normalizeOffseasonState(target=universe){
 const current=target.offseason;
 if(current&&current.year===target.year){
  target.offseason=makeOffseasonState(target.year,current.phase,current.completed,current.reports);
  return target.offseason;
 }
 const ds=target.developmentState||{},complete=target.phase==='complete';
 const completed=[];
 if(complete&&ds.year===target.year&&ds.springRun)completed.push('spring');
 if(complete&&ds.year===target.year&&ds.fallRun)completed.push('fall');
 const reports=complete&&(completed.length||target.offseasonDone)?{migration:{legacyDevelopment:true,offseasonDone:!!target.offseasonDone}}:{};
 target.offseason=makeOffseasonState(target.year,complete?'review':'preseason',complete?completed:['preseason'],reports);
 return target.offseason;
}
function runSpringCamp(){if(universe.phase!=='complete'){setStatus('Finish the season before spring development.');return}let ds=ensureDevelopmentState();if(ds.springRun){setStatus('Spring development has already been completed.');return}for(const t of universe.teams)advanceSchemeInstall(t,'spring');let u=selected(),report=[];for(const t of universe.teams){for(const p of t.roster){p.lastDevelopmentDelta=0;const before=developmentSnapshot(p);applyDevelopmentPhase(p,t,'spring');if(t===u){refreshScoutingIntel(p,t,9,'CAMP');snapshotScouting(p,t,'MAJOR_REVISION','CAMP',false,true);const result=developmentResult(p,t,'spring',before);report.push(result);p.campHistory.push({year:universe.year,phase:'Spring',delta:result.overallDelta,attr:{...result.attr},weightDelta:result.weightDelta,focus:result.focus,teamFocus:result.teamFocus})}}if(t!==u&&gameplayRandom()<.35)t.trainingFocus=pick(Object.keys(TEAM_TRAINING));autoRoleDepth(t,false)}ds.springRun=true;ds.springReport=report.sort((a,b)=>b.delta-a.delta);ds.battles=buildCampBattles(u,'spring');setStatus('Spring development complete. Staff evaluations have tightened.');render()}
function runFallCamp(){if(universe.phase!=='complete'){setStatus('Finish the season before fall camp.');return}let ds=ensureDevelopmentState();if(!ds.springRun){setStatus('Run spring development first.');return}for(const t of universe.teams)advanceSchemeInstall(t,'fall');if(ds.fallRun){setStatus('Fall camp has already been completed.');return}let u=selected(),report=[];for(const t of universe.teams){for(const p of t.roster){const before=developmentSnapshot(p);applyDevelopmentPhase(p,t,'fall');p.campGrade=grade(clamp(Math.round(p.perceived+p.work*.08+p.composure*.05+gauss()*5),25,99));if(t===u){refreshScoutingIntel(p,t,7,'CAMP');snapshotScouting(p,t,'FIRST_FALL_CAMP','CAMP');const result=developmentResult(p,t,'fall',before,{grade:p.campGrade});report.push(result);p.campHistory.push({year:universe.year,phase:'Fall',grade:p.campGrade,delta:result.overallDelta,attr:{...result.attr},focus:result.focus,teamFocus:result.teamFocus})}else p.campHistory.push({year:universe.year,phase:'Fall',grade:p.campGrade,delta:p.trueNow-before.trueNow})}if(t!==u)autoRoleDepth(t,false)}ds.fallRun=true;ds.fallReport=report.sort((a,b)=>b.delta-a.delta);ds.battles=buildCampBattles(u,'fall');setStatus('Fall camp complete. Position battles are ready for decisions.');render()}
...
function recordPromiseTraining(p,phase){const trainingYear=universe.year+(universe.phase==='complete'?1:0);for(const q of p.promises||[])if(q.status==='ACTIVE'&&q.type==='DEVELOPMENT_PLAN'&&q.firstSeason===trainingYear&&p.trainingFocus===q.expectedFocus&&!(q.trainingPhases??=[]).includes(phase))q.trainingPhases.push(phase)}
...
function extendOffer(openingId,candidateId,offer){
 ...
 const chance=candidateAcceptChance(cand,{salary,years,authority}),accepted=gameplayRandom()<chance;
...
function weightedHighSchool(pool){let total=pool.reduce((a,h)=>a+h.talent,0),r=gameplayRandom()*total;for(const h of pool){r-=h.talent;if(r<=0)return h}return pool.at(-1)}
...
const QB_RUSH_STYLE_WEIGHT={'Rhythm Distributor':.03,'Field Architect':.04,'Off-Script Creator':.095,'Vertical Hunter':.045,'Power Creator':.075,'Run-First Weapon':.155,'Toolsy Project':.065,'Backyard Magician':.085};
const QB_RUSH_SCHEME_WEIGHT={'Tempo Spread':.025,'Vertical Strike':0,'Rhythm Control':-.005,'Ground Pressure':.015,'Option Motion':.065,'Heavy Play Action':.005,'Multiple':.01};
function qbRushWeight(q,team){if(!q)return 0;const base=QB_RUSH_STYLE_WEIGHT[q.style]??.055,scheme=QB_RUSH_SCHEME_WEIGHT[team?.offScheme]??0,mobility=clamp((((q.speed??q.trueNow)*.65+(q.versatility??q.trueNow)*.35)-70)*.0015,-.035,.045);return Math.round(clamp(base+scheme+mobility,.02,.26)*1000)/1000}
// Opportunity multipliers say how a player is used inside his assigned role.
// Ratings still decide role fit and how efficiently the resulting chances go.
const STYLE_USAGE={
 'Gap Hammer':{carry:1.18,target:.72},'Space Cutter':{carry:1.02,target:1.08},'Contact Glider':{carry:1.12,target:.86},'Third-Down Weapon':{carry:.72,target:1.55},'One-Cut Burner':{carry:1.15,target:.72},'Patient Slasher':{carry:1.08,target:.88},
 'Boundary Bully':{target:1.04},'Space Hunter':{target:1.10},'Route Sculptor':{target:1.12},'Vertical Glider':{target:.94},'Catch-Point Ace':{target:1.04},'YAC Creator':{target:1.02},'Motion Weapon':{target:1.10},
 'Seam Hunter':{target:1.10,protect:1.08},'Inline Mauler':{target:.78,protect:.86},'Move Chesspiece':{target:1.18,protect:1.12},'Red-Zone Tower':{target:1.02,protect:1.06},'Backfield Hybrid':{target:1.16,protect:1.04},
 'Island Protector':{protect:.78},'Movement Tackle':{protect:1.08},'Power Edge':{protect:.90},'Long-Frame Project':{protect:1.15},'Drive Blocker':{protect:1.05},'Phone-Booth Anchor':{protect:.82},'Pulling Guard':{protect:1.12},'Interior Technician':{protect:.80},'Protection Quarterback':{protect:.76},'Leverage Center':{protect:.86},'Movement Pivot':{protect:1.10},'Power Pivot':{protect:.92},
 'Pocket Wrecker':{rush:1.24,tackle:.94},'Speed Bender':{rush:1.20,tackle:.88},'Power Setter':{rush:.94,tackle:1.18},'Chaos Rusher':{rush:1.16,tackle:.92},'Run-Side Anchor':{rush:.78,tackle:1.25},'Pocket Crusher':{rush:1.18,tackle:1.02},'Gap Eater':{rush:.76,tackle:1.25},'Penetrator':{rush:1.22,tackle:.94},'Two-Gap Anchor':{rush:.74,tackle:1.28},'Interior Disruptor':{rush:1.20,tackle:1.00},
 'Range Hunter':{tackle:1.14,coverage:1.04,takeaway:1.04},'Box Enforcer':{tackle:1.24,coverage:.82,takeaway:.86},'Coverage Rover':{tackle:.94,coverage:1.18,takeaway:1.12},'Pressure Backer':{tackle:1.00,rush:1.22,coverage:.84},'Traffic Director':{tackle:1.10,coverage:1.10,takeaway:1.08},
 'Mirror Corner':{coverage:1.18,takeaway:.94,tackle:.88},'Press Eraser':{coverage:1.14,takeaway:.96,tackle:1.00},'Ball Hunter':{coverage:1.04,takeaway:1.30,tackle:.88},'Boundary Fighter':{coverage:1.00,takeaway:.94,tackle:1.15},'Slot Shadow':{coverage:1.16,takeaway:1.02,tackle:1.04},
 'Centerfielder':{coverage:1.12,takeaway:1.22,tackle:.88},'Box Hammer':{coverage:.82,takeaway:.88,tackle:1.28},'Coverage Eraser':{coverage:1.22,takeaway:1.12,tackle:.90},'Hybrid Rover':{coverage:1.06,takeaway:1.04,tackle:1.12},'Trigger Safety':{coverage:1.04,takeaway:1.14,tackle:1.10}
};
function playerUsageWeight(p,kind,base=1){return !p?0:base*(STYLE_USAGE[p.style]?.[kind]??1)}
function rushingShares(team){const q=roleStarter(team,'QB1')||starter(team,'QB'),part=(p,weight)=>({p,weight:p?.pos==='QB'?weight:playerUsageWeight(p,'carry',weight)});return mergeShares([part(roleStarter(team,'RB1'),.46),part(rotationAt(team,'RB',1),.19),part(roleStarter(team,'3DRB'),.11),part(roleStarter(team,'PWRB'),.10),part(rotationAt(team,'RB',2),.06),part(q,qbRushWeight(q,team))],.62)}
function receivingShares(team){const part=(p,weight)=>({p,weight:playerUsageWeight(p,'target',weight)});return mergeShares([part(roleStarter(team,'X'),.21),part(roleStarter(team,'Z'),.19),part(roleStarter(team,'SLOT'),.18),part(roleStarter(team,'TE1'),.14),part(roleStarter(team,'3DRB'),.08),part(roleStarter(team,'MOVETE'),.05),part(rotationAt(team,'WR',3),.07),part(rotationAt(team,'WR',4),.04),part(rotationAt(team,'TE',1),.04)],.36)}
function defensiveShares(team){return mergeShares([...['MIKE','WILL','BOXS','FS','BCB','FCB','NICKEL','RUSH','SETEDGE','3TECH','NT'].map(id=>({p:roleStarter(team,id),weight:1})),...[['DT',.52],['EDGE',.44],['LB',.34],['CB',.28],['S',.26]].flatMap(([pos,w])=>[{p:rotationAt(team,pos,2),weight:w},{p:rotationAt(team,pos,3),weight:w*.45}])],1.35)}
function defensiveActor(team,kind,positions){const traits={tackle:{iq:.5,technique:.5},rush:{technique:.45,speed:.35,power:.2},takeaway:{iq:.4,technique:.35,speed:.25},coverage:{technique:.5,speed:.3,iq:.2}}[kind]||{iq:.5,technique:.5},parts=defensiveShares(team).filter(x=>!positions||positions.includes(x.p.pos)).map(x=>({p:x.p,weight:x.weight*playerUsageWeight(x.p,kind)*Object.entries(traits).reduce((n,[key,w])=>n+(x.p[key]??x.p.trueNow)*w,0)}));return weightedPlayer(parts)}
function weightedPlayer(parts){if(!parts.length)return null;const total=parts.reduce((n,x)=>n+Math.max(.01,x.weight),0);let roll=gameplayRandom()*total;for(const x of parts){roll-=Math.max(.01,x.weight);if(roll<=0)return x.p}return parts.at(-1).p}
function fieldGoalChance(k,distance=38,pressure=false){if(!k)return .55;const rangePenalty=Math.max(0,distance-32)*(.0095-Math.max(-20,k.power-70)*.00004),pressureWeight=pressure?.003:.0015;return clamp(.90+(k.technique-75)*.005+(k.power-75)*.002+(k.composure-75)*pressureWeight-rangePenalty,.20,.98)}
function quickFieldGoals(team,attempts,O,D){const k=roleStarter(team,'K1')||starter(team,'K');let made=0;for(let i=0;i<attempts;i++){const distance=clamp(Math.round(39+(D.defense-O.offense)*.10+gauss()*6),22,59);if(gameplayRandom()<fieldGoalChance(k,distance,i===attempts-1))made++}return made}
function puntAverage(p,noise=gauss()){return clamp(41+(p?.power-70)*.18+(p?.technique-70)*.08+noise*1.2,33,53)}
function exactOffenseLine(lines,p){let x=lines.get(p.id);if(!x){x={p,stats:newStats()};lines.set(p.id,x)}return x.stats}
function exactDefenseLine(lines,p){let x=lines.get(p.id);if(!x){x={p,stats:newStats()};lines.set(p.id,x)}return x.stats}
...
function applyGameStats(team,s,opp,exactOffense=null,exactDefense=null){const q=roleStarter(team,'QB1')||starter(team,'QB');let core=[q,roleStarter(team,'RB1'),roleStarter(team,'X'),roleStarter(team,'Z'),roleStarter(team,'SLOT'),roleStarter(team,'TE1'),roleStarter(team,'LT'),roleStarter(team,'LG'),roleStarter(team,'C1'),roleStarter(team,'RG'),roleStarter(team,'RT'),roleStarter(team,'RUSH'),roleStarter(team,'SETEDGE'),roleStarter(team,'NT'),roleStarter(team,'3TECH'),roleStarter(team,'MIKE'),roleStarter(team,'WILL'),roleStarter(team,'NICKEL'),roleStarter(team,'BCB'),roleStarter(team,'FCB'),roleStarter(team,'FS'),roleStarter(team,'BOXS')].filter(Boolean);const starters=new Set();for(const p of [...new Map(core.map(p=>[p.id,p])).values()]){addGameAppearance(p,true);starters.add(p.id)}
 let qbs=[],rushers=[],recs=[];if(exactOffense){for(const x of exactOffense.values()){for(const k of ['passAtt','passComp','passYds','passTD','int','sacksTaken','rushAtt','rushYds','rushTD','targets','receptions','recYds','recTD','drops','yac'])x.p.stats[k]+=(x.stats[k]||0);if(x.stats.passAtt||x.stats.sacksTaken)qbs.push({p:x.p});if(x.stats.rushAtt)rushers.push({p:x.p});if(x.stats.targets)recs.push({p:x.p})}}
 else{const qb2=rotationAt(team,'QB',1),margin=(s.pts||0)-(opp?.pts||0),qb2Share=!qb2?0:margin>=35?.32:margin>=21?.20:0;qbs=qb2Share?[{p:q,weight:1-qb2Share},{p:qb2,weight:qb2Share}]:[{p:q,weight:1}];qbs=mergeShares(qbs.filter(x=>x.p));if(qbs.length){for(const k of ['passAtt','passComp','passYds','passTD','int','sacksTaken']){let split=splitInteger(s[k]||0,qbs);for(const x of qbs)x.p.stats[k]+=(split.get(x.p)||0)}}
 rushers=rushingShares(team);let att=splitInteger(s.rushAtt||0,rushers),yds=splitInteger(Math.max(0,s.rushYds||0),rushers.map(x=>({p:x.p,weight:x.weight*(x.p.speed*.45+x.p.power*.35+x.p.iq*.20)}))),td=splitInteger(s.rushTD||0,rushers.map(x=>({p:x.p,weight:x.weight*(x.p.power*.6+x.p.composure*.4)})));for(const x of rushers){x.p.stats.rushAtt+=(att.get(x.p)||0);x.p.stats.rushYds+=(yds.get(x.p)||0);x.p.stats.rushTD+=(td.get(x.p)||0)}
 recs=receivingShares(team);let catches=splitInteger(s.passComp||0,recs.map(x=>({p:x.p,weight:x.weight*(x.p.technique*.55+x.p.iq*.30+x.p.composure*.15)}))),extraTargets=splitInteger(Math.max(0,(s.passAtt||0)-(s.passComp||0)),recs),ryds=splitInteger(Math.max(0,s.passYds||0),recs.map(x=>({p:x.p,weight:x.weight*(x.p.speed*.42+x.p.technique*.38+x.p.power*.2)}))),rtd=splitInteger(s.passTD||0,recs.map(x=>({p:x.p,weight:x.weight*(x.p.technique*.45+x.p.power*.3+x.p.composure*.25)})));for(const x of recs){let c=catches.get(x.p)||0,tg=c+(extraTargets.get(x.p)||0);x.p.stats.targets+=tg;x.p.stats.receptions+=c;x.p.stats.recYds+=(ryds.get(x.p)||0);x.p.stats.recTD+=(rtd.get(x.p)||0);x.p.stats.yac+=Math.round((ryds.get(x.p)||0)*rng(.25,.48));x.p.stats.drops+=Math.max(0,Math.round((tg-c)*clamp((90-x.p.technique)/250,0,.15)))} }
 let defShares=defensiveShares(team),def=defShares.map(x=>x.p);
 if(exactDefense){for(const x of exactDefense.values())for(const k of ['tackles','tfl','sacks','pressures','intDef','passBreakups','forcedFumbles'])x.p.stats[k]+=(x.stats[k]||0)}
 else{let posWeight=p=>(p.pos==='LB'?1.25:p.pos==='S'?1.05:p.pos==='DT'?.8:1),tackleTotal=Math.max(35,Math.round((opp?.plays||65)*.72)),tacks=splitInteger(tackleTotal,defShares.map(x=>({p:x.p,weight:x.weight*playerUsageWeight(x.p,'tackle')*posWeight(x.p)*(x.p.iq*.5+x.p.technique*.5)})));for(const p of def)p.stats.tackles+=(tacks.get(p)||0);let front=defShares.filter(x=>['EDGE','DT','LB'].includes(x.p.pos)),sacks=splitInteger(opp?.sacksTaken||0,front.map(x=>({p:x.p,weight:x.weight*playerUsageWeight(x.p,'rush')*(x.p.technique*.55+x.p.speed*.25+x.p.power*.2)}))),press=splitInteger(Math.max(opp?.sacksTaken||0,Math.round((opp?.passAtt||30)*.14)),front.map(x=>({p:x.p,weight:x.weight*playerUsageWeight(x.p,'rush')*(x.p.technique*.45+x.p.speed*.35+x.p.power*.2)})));for(const {p} of front){p.stats.sacks+=(sacks.get(p)||0);p.stats.pressures+=(press.get(p)||0);p.stats.tfl+=Math.round((tacks.get(p)||0)*rng(.08,.25))}let db=defShares.filter(x=>['CB','S','LB'].includes(x.p.pos)),ints=splitInteger(opp?.int||0,db.map(x=>({p:x.p,weight:x.weight*playerUsageWeight(x.p,'takeaway')*(x.p.iq*.4+x.p.technique*.35+x.p.speed*.25)}))),pbus=splitInteger(Math.max(0,Math.round(((opp?.passAtt||0)-(opp?.passComp||0)-(opp?.int||0))*0.24)),db.map(x=>({p:x.p,weight:x.weight*playerUsageWeight(x.p,'coverage')*(x.p.technique*.5+x.p.speed*.3+x.p.iq*.2)})));for(const {p} of db){p.stats.intDef+=(ints.get(p)||0);p.stats.passBreakups+=(pbus.get(p)||0)}}
 let ol=[...new Map(['LT','LG','C1','RG','RT'].map(id=>roleStarter(team,id)).filter(Boolean).map(p=>[p.id,p])).values()],snaps=(s.plays||((s.passAtt||0)+(s.rushAtt||0)+(s.sacksTaken||0)));for(const p of ol)p.stats.snaps+=snaps;let protectionWeight=p=>(110-p.technique)*playerUsageWeight(p,'protect'),sa=splitInteger(s.sacksTaken||0,ol.map(p=>({p,weight:protectionWeight(p)}))),pa=splitInteger(Math.max(s.sacksTaken||0,Math.round((s.passAtt||30)*.07)),ol.map(p=>({p,weight:protectionWeight(p)})));for(const p of ol){p.stats.sacksAllowed+=(sa.get(p)||0);p.stats.pressuresAllowed+=(pa.get(p)||0)}
 let k=roleStarter(team,'K1'),pu=roleStarter(team,'P1');if(k){k.stats.fgMade+=s.fgMade||0;k.stats.fgAtt+=s.fgAtt||0}if(pu){pu.stats.punts+=s.punts||0;pu.stats.puntYds+=Math.round((s.punts||0)*puntAverage(pu))}
...
function generatePlayer(school,pos,idx){
 ...
 const attrs=generatePositionAttributes(pos,trueNow),style=styleForTraits(pos,attrs);
 ...
 let role=idx<Math.ceil((POS_COUNTS[pos]||4)*.35)?'Starter mix':idx<Math.ceil((POS_COUNTS[pos]||4)*.7)?'Rotation':'Development';if(classYr==='FR'&&role==='Development')role='Redshirt candidate';let eligibilityUsed={FR:0,SO:1,JR:2,SR:3}[classYr],redshirtUsed=eligibilityUsed>0&&gameplayRandom()<.28;
 let growthProfile=pick(GROWTH_PROFILE_KEYS),growthVolatility=clamp(Math.round(45+gauss()*22),10,95),framePotential=clamp(Math.round(58+gauss()*20),10,98),speedRetention=clamp(Math.round(70+gauss()*16),20,99),scoutConfidence=clamp(Math.round(38+eligibilityUsed*13+school.development*.18+gauss()*5),28,94);return {id:uid(),name:`${pick(FIRST)} ${pick(LAST)}`,pos,year:classYr,eligibilityUsed,redshirtUsed,redshirtActive:false,redshirtSeason:null,height:h,weight:w,style,trueNow,upside,perceived,perceivedUpside,dev,work,coach,morale,role,...attrs,health:100,wear:gi(0,8),injury:null,injuryWeeks:0,injuryHistory:[],seasonHistory:[],awards:[],draftResult:null,promise:null,promiseBaseline:perceived,growthProfile,growthVolatility,framePotential,speedRetention,heightGrowthRemaining:eligibilityUsed===0&&gameplayRandom()<.24?1:0,trainingFocus:'Balanced',positionFamiliarity:{[pos]:100},formerPositions:[],scoutConfidence,lastDevelopmentDelta:0,lastPhysicalChange:'',campGrade:null,campHistory:[],stats:newStats(),career:newStats(),origin:'Initial roster',portraitSeed:portraitSeedFor(),portraitVersion:PORTRAIT_VERSION};
}
...
function generateRecruitPool(n,hsPool=universe?.highSchools||generateHighSchools()){let out=[];for(let i=0;i<n;i++){let pos=pick(POS.filter(x=>!['K','P'].includes(x))),raw=clamp(Math.round(58+gauss()*12),38,97),st=recruitStars(raw),up=clamp(Math.round(raw+rng(4,22)+gauss()*5),raw,99),h=weightedHighSchool(hsPool),traits=generatePositionAttributes(pos,raw),style=styleForTraits(pos,traits);out.push({id:uid(),name:`${pick(FIRST)} ${pick(LAST)}`,pos,stars:st,style,trueNow:raw,upside:up,...traits,scout:clamp(Math.round(raw+gauss()*6),35,99),scoutUp:clamp(Math.round(up+gauss()*8),40,99),highSchoolId:h.id,highSchool:h.name,homeCity:h.city,homeState:h.state,lat:h.lat,lon:h.lon,homeRegion:h.region,distanceImportance:gi(5,100),distanceTolerance:pick([100,150,250,400,600,900,1500,2500]),priority:pick(PRIORITIES),portraitSeed:portraitSeedFor(),portraitVersion:PORTRAIT_VERSION,targeted:false,interest:gi(5,45),prevInterest:0,trend:0,relationship:gi(0,20),leader:null,committed:null,commitWeek:null,visit:false,visitWeek:null,promise:'None',work:clamp(Math.round(65+gauss()*18),15,99),dev:clamp(Math.round(68+gauss()*18),15,99)});out.at(-1).prevInterest=out.at(-1).interest}return assignRecruitRanks(out)}
function initUniverse(mode='dynasty',{startingPhase='regular',seed=null}={}){const phase=startingPhase==='preseason'?'preseason':'regular';IDX.teams=null;IDX.players=null;activateGameplayRng(seed??undefined);const os=Object.keys(OFF_SCHEMES),ds=Object.keys(DEF_SCHEMES),highSchools=generateHighSchools();const teams=schools.map(s=>({...s,nickname:'',staff:generateStaff(s),offScheme:pick(os),defScheme:pick(ds),roster:generateRoster(s),...schoolColors(s),w:0,l:0,cw:0,cl:0,pf:0,pa:0,sos:0,rank:null,champ:false,schedule:[],history:[],commits:[],records:{}}));for(const t of teams){t.schemeTransition={off:null,def:null};t.staff.OC.preferredScheme=t.offScheme;t.staff.DC.preferredScheme=t.defScheme;t.pipelines=makePipelines(t);autoRedshirts(t);autoDepthTeam(t,false);autoRoleDepth(t,false)}universe={version:APP_VERSION,mode:mode==='commissioner'?'commissioner':'dynasty',year:2027,week:0,recoveredWeek:-1,phase,teams,highSchools,recruits:generateRecruitPool(2800,highSchools),history:[],playerArchive:[],awards:{},records:{nationalSeason:{},nationalCareer:{}},draftHistory:{},latest:[],weeklyHub:[],weeklyDecisions:[],bowls:[],confChamps:[],playoffFieldIds:[],playoffFieldUnavailable:false,academicProgression:{season:2027,week:0,teamIds:[]},champion:null,lastDetailedGame:null,movementLog:[],recruitClassCounts:{},campHistory:{},developmentState:{year:2027,springRun:false,fallRun:false,springReport:[],fallReport:[],battles:[]},offseasonDone:false,openings:[],candidateMarket:{},guidanceState:{version:1,teams:{}}};guidanceReturnState=null;normalizeGuidanceState();gameplayRngUniverse=universe;for(const t of teams){ensureTeamDevelopment(t);for(const p of t.roster){ensurePlayerDevelopment(p,t);ensureAcademics(p,t)}}normalizePromiseState();buildSchedule();deriveRivalries();universe.teams.forEach(t=>{ensureAdminState(t);ensureNilState(t)});ranked();buildPreseasonHub();syncGameplayRng()}
function createNewDynasty(mode='dynasty',options={}){return initUniverse(mode,{startingPhase:'preseason',seed:options.seed??null})}
...
function teamById(id,u=universe){return (u?.teams||[]).find(t=>String(t.id)===String(id))}
function conferenceChampionIdsFor(u=universe){
 const ids=[],teams=u?.teams||[];
 for(const ref of u?.confChamps||[]){
  const id=typeof ref==='object'?ref?.id:ref;
  const name=typeof ref==='object'?ref?.name:ref;
  const t=teams.find(t=>String(t.id)===String(id))||teams.find(t=>t.name===name);
  if(t&&!ids.includes(t.id))ids.push(t.id);
 }
 return ids;
}
function normalizeConferenceChampions(){universe.confChamps=conferenceChampionIdsFor(universe);return universe.confChamps}
function conferenceChampionTeams(){return conferenceChampionIdsFor(universe).map(id=>teamById(id)).filter(Boolean)}
function playoffFieldIdsFor(u=universe){
 const ids=[],teams=u?.teams||[];
 for(const id of u?.playoffFieldIds||[]){const t=teams.find(t=>String(t.id)===String(id));if(t&&!ids.includes(t.id))ids.push(t.id)}
 return ids;
}
function playoffFieldFromIds(){return playoffFieldIdsFor(universe).map(id=>teamById(id)).filter(Boolean)}
function selectPlayoffField(){let r=ranked(),champs=conferenceChampionTeams(),set=new Set(champs.map(t=>t.id)),ats=r.filter(t=>!set.has(t.id)).slice(0,6);return [...champs,...ats].map(t=>({t,s:rankingScore(t)})).sort((a,b)=>b.s-a.s).map(x=>x.t).slice(0,16)}
function freezePlayoffField(){const frozen=playoffFieldFromIds();if(frozen.length===16)return frozen;const field=selectPlayoffField();universe.playoffFieldIds=field.map(t=>t.id);universe.playoffFieldUnavailable=false;return field}
function normalizePlayoffField(){
 const ids=playoffFieldIdsFor(universe);
 if(ids.length===16){universe.playoffFieldIds=ids;universe.playoffFieldUnavailable=false;return}
 universe.playoffFieldIds=[];
 // Old saves that already played bowls never recorded the pre-bowl field. Re-selecting now
 // would turn bowl winners into playoff qualifiers, so leave that field explicitly unavailable.
 universe.playoffFieldUnavailable=universe.phase==='playoffReady'&&(universe.bowls||[]).length>0;
}
function rebuildRecruitClassCounts(){
 const counts={};
 for(const r of universe.recruits||[])if(r.committed)counts[r.committed]=(counts[r.committed]||0)+1;
 universe.recruitClassCounts=counts;
 for(const t of universe.teams||[])t.commits=(universe.recruits||[]).filter(r=>r.committed===t.name);
 return counts;
}
...
// Stored as an array so adding a second protected rivalry later is a data change, not a
// schema rewrite. Index 0 is the one the schedule reserves a round for today.
function primaryRivalId(t){return t?.protectedRivalIds?.[0]??null}
function setPrimaryRival(t,o){t.protectedRivalIds=[o.id]}
function ensureProtectedRivals(){
 ...
 for(const c of allConfs()){
  ...
  const taken=new Set();
  for(const t of arr){
   const o=byId.get(primaryRivalId(t));
   if(o&&primaryRivalId(o)===t.id&&o.conference===t.conference&&!taken.has(t.id)&&!taken.has(o.id)){taken.add(t.id);taken.add(o.id)}
   else if(primaryRivalId(t)&&!(o&&primaryRivalId(o)===t.id))t.protectedRivalIds=[];
  }
  ...
  for(const {t,o} of pairs){
   ...
   setPrimaryRival(t,o);setPrimaryRival(o,t);taken.add(t.id);taken.add(o.id);
  }
 }
}
...
function migrateProtectedRivals(){
 ...
 for(const t of universe.teams){
  if(primaryRivalId(t)||!t.rivalry?.rivalId)continue;
  const o=byId.get(t.rivalry.rivalId);
  if(o&&o.rivalry?.rivalId===t.id&&o.conference===t.conference){setPrimaryRival(t,o);setPrimaryRival(o,t)}
 }
...
function gameLink(id,label='Open Game Center',tab='Summary',primary=false){return id?`<button type="button" class="game-link${primary?' game-link--primary':''}" data-game="${gameEscape(id)}" data-game-tab="${gameEscape(tab)}">${gameEscape(label)}</button>`:'<span class="muted">Box score unavailable (older save)</span>'}
function gameResultActions(id){return id?`<div class="game-result-actions">${gameLink(id,'View Box Score','Box Score',true)}${gameLink(id,'Full Game Center')}</div>`:'<span class="muted">Box score unavailable (older save)</span>'}
function gameSortCompare(a,b){const av=a??'',bv=b??'',an=Number(av),bn=Number(bv),numeric=av!==''&&bv!==''&&Number.isFinite(an)&&Number.isFinite(bn);return numeric?an-bn:String(av).localeCompare(String(bv),undefined,{numeric:true,sensitivity:'base'})}
function gameTable(headers,rows,{sortable=false,defaultSort=null}={}){
 const ordered=defaultSort==null?rows:[...rows].sort((a,b)=>gameSortCompare(b[defaultSort],a[defaultSort])||gameSortCompare(a[0],b[0]));
 const head=headers.map((x,i)=>sortable?`<th class="sortable${i===defaultSort?' sorted':''}" aria-sort="${i===defaultSort?'descending':'none'}"${i===defaultSort?' data-dir="desc"':''}><button type="button" class="game-sort-button" data-game-sort="${i}" aria-label="${gameEscape(x)}" title="Sort by ${gameEscape(x)}">${gameEscape(x)}</button></th>`:`<th>${gameEscape(x)}</th>`).join('');
 const body=ordered.map(row=>`<tr>${row.map(x=>`<td data-sort-value="${gameEscape(x??'')}">${gameEscape(x??'—')}</td>`).join('')}</tr>`).join('');
 return `<div class="table-wrap game-table"><table><thead><tr>${head}</tr></thead><tbody>${body}</tbody></table></div>`;
}
...
function gameBoxHTML(g){
 ...
 const groups=[['Passing',['Cmp','Att','Yds','TD','INT','Sacks'],['passComp','passAtt','passYds','passTD','int','sacksTaken'],'passAtt',4],['Rushing',['Car','Yds','Avg','TD'],['rushAtt','rushYds','rushAvg','rushTD'],'rushAtt',3],['Receiving',['Rec','Targets','Yds','Avg','TD'],['receptions','targets','recYds','recAvg','recTD'],'targets',4],['Defense',['Tkl','TFL','Sack','INT','PD','Pressures'],['tackles','tfl','sacks','intDef','passBreakups','pressures'],'tackles',2],['Kicking',['FGM','FGA'],['fgMade','fgAtt'],'fgAtt',2],['Punting',['Punts','Yds','Avg'],['punts','puntYds','puntAvg'],'punts',3]];
 const filters=`<div class="game-box-controls" aria-label="Box score filters"><label>Player team<select data-game-box-team><option value="all">Both teams</option><option value="away">${gameEscape(g.away.name)}</option><option value="home">${gameEscape(g.home.name)}</option></select></label><label>Category<select data-game-box-category><option value="all">All categories</option>${groups.map(([title])=>`<option value="${title.toLowerCase()}">${title}</option>`).join('')}</select></label><output data-game-box-status aria-live="polite">Showing both teams · all categories</output></div>`;
 let html=compactNote+filters+'<h3>Team statistics</h3>'+gameTable(['Statistic',g.away.name,g.home.name],rows)+'<p class="muted">Quarter scores, possession, third/fourth downs, penalties and long gains are not tracked. Player totals are allocated by the simulation from team production.</p><div class="game-player-stats">';
 for(const side of ['away','home']){html+=`<section class="game-stat-team" data-game-stat-team="${side}"><h3>${gameEscape(g[side].name)}</h3>`;for(const [title,cols,keys,filter,defaultSort] of groups){const list=g.playerStats[side].filter(p=>p.stats[filter]||keys.some(k=>p.stats[k]));if(!list.length)continue;const category=title.toLowerCase();html+=`<section class="game-stat-group" data-game-stat-category="${category}"><h4>${title}</h4>`+gameTable(['Player','Pos',...cols],list.map(p=>[p.name,p.pos,...keys.map(k=>{const s=p.stats;if(k==='rushAvg')return s.rushAtt?((s.rushYds||0)/s.rushAtt).toFixed(1):'—';if(k==='recAvg')return s.receptions?((s.recYds||0)/s.receptions).toFixed(1):'—';if(k==='puntAvg')return s.punts?((s.puntYds||0)/s.punts).toFixed(1):'—';return s[k]||0})]),{sortable:true,defaultSort})+'</section>'}html+='</section>'}
 html+='</div>';
 return html;
}
function bindGameBoxControls(){
 const root=$('#gameDialogBody'),teamFilter=root.querySelector('[data-game-box-team]'),categoryFilter=root.querySelector('[data-game-box-category]'),status=root.querySelector('[data-game-box-status]');if(!teamFilter||!categoryFilter)return;
 const applyFilters=()=>{const team=teamFilter.value,category=categoryFilter.value;for(const section of root.querySelectorAll('[data-game-stat-team]')){const teamVisible=team==='all'||section.dataset.gameStatTeam===team;let visibleGroups=0;for(const group of section.querySelectorAll('[data-game-stat-category]')){const visible=teamVisible&&(category==='all'||group.dataset.gameStatCategory===category);group.hidden=!visible;if(visible)visibleGroups++}section.hidden=!teamVisible||visibleGroups===0}if(status)status.textContent=`Showing ${teamFilter.selectedOptions[0].textContent} · ${categoryFilter.selectedOptions[0].textContent.toLowerCase()}`};
 teamFilter.addEventListener('change',applyFilters);categoryFilter.addEventListener('change',applyFilters);applyFilters();
 for(const button of root.querySelectorAll('[data-game-sort]'))button.addEventListener('click',()=>{const table=button.closest('table'),head=button.closest('th'),index=+button.dataset.gameSort,rows=[...table.tBodies[0].rows],was=head.getAttribute('aria-sort'),direction=was==='ascending'?'descending':was==='descending'?'ascending':rows.every(row=>{const value=row.cells[index]?.dataset.sortValue??'';return value!==''&&Number.isFinite(Number(value))})?'descending':'ascending';for(const other of table.querySelectorAll('th')){other.classList.remove('sorted');other.removeAttribute('data-dir');other.setAttribute('aria-sort','none')}head.classList.add('sorted');head.dataset.dir=direction==='ascending'?'asc':'desc';head.setAttribute('aria-sort',direction);rows.sort((a,b)=>{const result=gameSortCompare(a.cells[index]?.dataset.sortValue,b.cells[index]?.dataset.sortValue);return direction==='ascending'?result:-result});for(const row of rows)table.tBodies[0].appendChild(row)});
}
...
function showGameCenter(id,tab='Summary'){
 ...
 $('#gameDialogName').innerHTML=watching?`${teamLogoHTML(g.away.id,48,'team-logo--inline')} ${g.away.name} at ${teamLogoHTML(g.home.id,48,'team-logo--inline')} ${g.home.name}`:`${teamLogoHTML(g.away.id,48,'team-logo--inline')} ${g.away.name} ${g.score.away} — ${g.score.home} ${teamLogoHTML(g.home.id,48,'team-logo--inline')} ${g.home.name}`;
 ...
 $('#gameDialogBody').innerHTML=html;if(tab==='Box Score')bindGameBoxControls();const dialog=$('#gameDialog');if(!dialog.open)dialog.showModal();
}
...
function gameSim(home,away,neutral=false,confOverride=null,context={}){
 const before=beginGame(home,away,neutral,context),H=gameProfiles(home,away.name),A=gameProfiles(away,home.name);
 function side(O,D,team,scheme){
  const plays=clamp(Math.round(60+(scheme.pace-68)*.10+gauss()*4),52,72),passRate=clamp(scheme.pass+(O.qb-D.coverage)*.0012,.25,.64),passAtt=Math.round(plays*passRate),pressure=clamp(.13+(D.front-O.ol)*.0035+(DEF_SCHEMES[(team===home?away:home).defScheme].pressure-70)*.001+(D.prepPressure||0),.06,.30),sacksTaken=Math.round(passAtt*pressure*rng(.18,.34)),intRate=clamp(.018+(D.coverage-O.qb)*.0008,.008,.052),ints=Math.min(4,Math.round(passAtt*intRate+rng(-.25,.65))),compPct=clamp(.61+(O.qb-D.coverage)*.0032+gauss()*.025,.43,.78),passComp=clamp(Math.round(passAtt*compPct),0,passAtt-ints),ypc=clamp(9.8+(O.skill-D.coverage)*.045+gauss()*.7,7.0,13.8),passYds=Math.max(40,Math.round(passComp*ypc)),rushAtt=Math.max(15,plays-passAtt-sacksTaken),ypcRush=clamp(4.15+(O.ol-D.front)*.035+(O.skill-D.front)*.015+gauss()*.35,2.5,7.0),rushYds=Math.max(25,Math.round(rushAtt*ypcRush)),totalYds=passYds+rushYds,edge=(O.offense-D.defense)/12,tds=clamp(Math.round(totalYds/128+edge*.16+gauss()*.75),0,7),passTD=clamp(Math.round(tds*clamp(passRate+rng(-.10,.10),.25,.82)),0,tds),rushTD=tds-passTD,fgAtt=clamp(Math.round(1.55+(totalYds-300)/240+gauss()*.7),0,5),fg=quickFieldGoals(team,fgAtt,O,D),fumblesLost=gameplayRandom()<clamp(.45+(D.front-O.skill)*.01,.18,.80)?1:0,pts=tds*7+fg*3,firstDowns=Math.round(totalYds/18+rng(-2,3)),punts=clamp(Math.round(5.4-(tds+fg)*.42+gauss()*1.1),1,9);
  return {pts,plays,firstDowns,passAtt,passComp,passYds,passTD,int:ints,sacksTaken,rushAtt,rushYds,rushTD,fumblesLost,turnovers:ints+fumblesLost,recYds:passYds,recTD:passTD,fgMade:fg,fgAtt,punts};
 }
 const hs=side(H,A,home,OFF_SCHEMES[home.offScheme]),as=side(A,H,away,OFF_SCHEMES[away.offScheme]);let hp=hs.pts+homeFieldScoreBonus(home,neutral),ap=as.pts;if(hp===ap)(gameplayRandom()<.5?()=>hp+=3:()=>ap+=3)();const conf=confOverride??home.conference===away.conference,win=recordGame(home,away,hp,ap,conf,H,A);applyGameStats(home,hs,as);applyGameStats(away,as,hs);postGameCondition(home);postGameCondition(away);return finishGame(before,home,away,{home:home.name,away:away.name,hp,ap,winner:win.name,box:{home:hs,away:as}});
}
...
function detailedGame(home,away,neutral=false,confOverride=null,context={}){
 ...
 const exact={home:new Map(),away:new Map()},exactDef={home:new Map(),away:new Map()};
 function drive(off,def,O,D,scheme,out,label,actors,defenders){let pos=25,down=1,toGo=10,plays=0,last=null;const qb=starter(off,'QB'),oc=off.staff.OC,dc=def.staff.DC;while(plays<16){plays++;out.plays++;let pass=scheme.pass+(down===3?.18:0)+(toGo>=8?.09:0)-(toGo<=2?.13:0),pen=gameplayRandom()<.045;if(pen){if(gameplayRandom()<.65){pos=Math.max(1,pos-5);toGo+=5;log.push(`${label}: ${off.name} false start; backed up five.`)}else{pos=Math.min(99,pos+5);toGo=Math.max(1,toGo-5);log.push(`${label}: defensive penalty gives ${off.name} five.`)}continue}
 const isPass=gameplayRandom()<pass;if(isPass){
  const target=weightedPlayer(receivingShares(off))||starter(off,'WR'),qs=exactOffenseLine(actors,qb),ts=exactOffenseLine(actors,target),pressure=clamp(.17+(D.front-O.ol)*.005+(DEF_SCHEMES[def.defScheme].pressure-70)*.0015+(dc.playCall-70)*.001-(oc.playCall-70)*.0008+(D.prepPressure||0),.08,.48),pressured=gameplayRandom()<pressure,rushDef=pressured?(defensiveActor(def,'rush',['EDGE','DT','LB'])||starter(def,'EDGE')):null,rushStats=rushDef?exactDefenseLine(defenders,rushDef):null;
  if(rushStats)rushStats.pressures++;
  if(pressured&&gameplayRandom()<.28){let loss=gi(3,10);pos=Math.max(1,pos-loss);out.sacksTaken++;qs.sacksTaken++;rushStats.sacks++;rushStats.tackles++;rushStats.tfl++;down++;toGo+=loss;last=null;log.push(`${label}: ${rushDef.name} sacks ${qb.name} for ${loss}.`)}
  else{out.passAtt++;qs.passAtt++;ts.targets++;let intP=clamp(.027+(D.coverage-O.qb)*.0014+(75-qb.iq)*.0007+(pressured?.009:0),.008,.09);if(gameplayRandom()<intP){const thief=defensiveActor(def,'takeaway',['CB','S','LB'])||starter(def,'CB'),ds=exactDefenseLine(defenders,thief);out.int++;out.turnovers++;qs.int++;ds.intDef++;log.push(`${label}: ${thief.name} intercepts ${qb.name} targeting ${target.name} near the ${Math.min(99,pos+gi(5,22))}.`);return {points:0,result:'INT',plays}}let comp=clamp(.61+(O.qb-D.coverage)*.004+(qb.technique-70)*.0015+(target.technique-70)*.0007-(pressured?.07:0),.38,.81);if(gameplayRandom()<comp){let y=Math.round(clamp(7+(O.skill-D.coverage)/8+gauss()*6,0,38));if(gameplayRandom()<.055+(qb.speed+target.speed-140)*.0005)y+=gi(12,38);pos+=y;out.passComp++;out.passYds+=y;out.recYds+=y;qs.passComp++;qs.passYds+=y;ts.receptions++;ts.recYds+=y;ts.yac+=Math.round(y*rng(.25,.48));last={type:'pass',qs,ts};const tackler=pos<100?(defensiveActor(def,'tackle')||starter(def,'LB')):null;if(tackler)exactDefenseLine(defenders,tackler).tackles++;if(y>=toGo){out.firstDowns++;down=1;toGo=Math.min(10,100-pos)}else{down++;toGo-=y}log.push(`${label}: ${qb.name} to ${target.name} for ${y}${tackler?`; tackle by ${tackler.name}`:''}.`)}else{const dropped=gameplayRandom()<clamp((90-target.technique)/250,0,.15);if(dropped)ts.drops++;const cover=!dropped&&gameplayRandom()<.35?(defensiveActor(def,'coverage',['CB','S','LB'])||starter(def,'CB')):null;if(cover)exactDefenseLine(defenders,cover).passBreakups++;last=null;down++;log.push(`${label}: ${qb.name} incomplete for ${target.name}${cover?`; broken up by ${cover.name}`:''}.`)}}
 }
 else{const rusher=weightedPlayer(rushingShares(off))||starter(off,'RB'),rs=exactOffenseLine(actors,rusher);out.rushAtt++;rs.rushAtt++;let runEdge=(O.ol*.38+O.skill*.25+rusher.power*.15+rusher.speed*.12+oc.playCall*.10)-(D.front*.60+DEF_SCHEMES[def.defScheme].run*.20+dc.playCall*.20),y=Math.round(clamp(3.7+runEdge/20+gauss()*3.2,-4,24));if(gameplayRandom()<.045+Math.max(0,rusher.speed-82)*.001)y+=gi(10,32);pos+=y;out.rushYds+=y;rs.rushYds+=y;last={type:'run',rs};const tackler=pos<100?(defensiveActor(def,'tackle')||starter(def,'LB')):null;if(tackler){const ds=exactDefenseLine(defenders,tackler);ds.tackles++;if(y<0)ds.tfl++}if(y>=toGo){out.firstDowns++;down=1;toGo=Math.min(10,100-pos)}else{down++;toGo=Math.max(1,toGo-y)}log.push(`${label}: ${rusher.name} ${rusher===qb?'keeps':'runs'} for ${y}${tackler?`; tackle by ${tackler.name}`:''}.`)}
 if(pos>=100){if(last?.type==='pass'){out.passTD++;out.recTD++;last.qs.passTD++;last.ts.recTD++}else{out.rushTD++;if(last?.rs)last.rs.rushTD++}log.push(`${label}: TOUCHDOWN ${off.name}.`);return {points:7,result:'TD',plays}}
 if(down>=4){if(pos>=62){const dist=117-pos,k=roleStarter(off,'K1')||starter(off,'K'),pct=fieldGoalChance(k,dist,true);out.fgAtt++;if(gameplayRandom()<pct){out.fgMade++;log.push(`${label}: ${k.name} field goal good from ${Math.round(dist)}.`);return {points:3,result:'FG',plays}}log.push(`${label}: ${k.name} misses the field goal from ${Math.round(dist)}.`);return {points:0,result:'MISS',plays}}const p=roleStarter(off,'P1')||starter(off,'P');out.punts++;log.push(`${label}: ${p.name} punts.`);return {points:0,result:'PUNT',plays}}
 }return {points:0,result:'END',plays}}
 let hp=0,ap=0;const driveCount=detailedDriveCount(hScheme,aScheme),openingSide=gameplayRandom()<.5?'home':'away',sideCounts={home:0,away:0};for(let i=0;i<driveCount;i++){const side=i%2?(openingSide==='home'?'away':'home'):openingSide,isHome=side==='home',label=`${isHome?'H':'A'}${++sideCounts[side]}`,logStart=log.length,d=drive(isHome?home:away,isHome?away:home,isHome?H:A,isHome?A:H,isHome?hScheme:aScheme,totals[side],label,exact[side],exactDef[isHome?'away':'home']);d.playByPlay=log.slice(logStart).map(x=>x.startsWith(label+': ')?x.slice(label.length+2):x);if(isHome)hp+=d.points;else ap+=d.points;drives.push({side,label,...d})}hp+=homeFieldScoreBonus(home,neutral);if(hp===ap){log.push('Overtime required.');if(gameplayRandom()<.5)hp+=3;else ap+=3}const conf=confOverride??home.conference===away.conference,win=recordGame(home,away,hp,ap,conf,H,A);totals.home.pts=hp;totals.away.pts=ap;applyGameStats(home,totals.home,totals.away,exact.home,exactDef.home);applyGameStats(away,totals.away,totals.home,exact.away,exactDef.away);postGameCondition(home);postGameCondition(away);return finishGame(before,home,away,{home:home.name,away:away.name,hp,ap,winner:win.name,log:log.slice(-160),box:totals,detailed:true,drives});
}
function seasonScore(p,t){let s=p.stats||{},teamBonus=(t?.w||0)*1.5,base=p.perceived*.12;if(p.pos==='QB')return base+s.passYds*.010+s.passTD*2.4-s.int*1.4+(s.passAtt?((s.passComp/s.passAtt)-.58)*35:0)+(s.rushYds||0)*.018+(s.rushTD||0)*2-(s.fumbles||0)*.8+teamBonus;if(p.pos==='RB')return base+s.rushYds*.026+s.rushTD*3+(s.receptions||0)*.12+(s.recYds||0)*.012+(s.recTD||0)*1.6-(s.fumbles||0)*.8+teamBonus;if(['WR','TE'].includes(p.pos))return base+s.recYds*.028+s.recTD*3.1+(s.receptions||0)*.28-(s.drops||0)*.8+teamBonus;if(['EDGE','DT','LB','CB','S'].includes(p.pos))return base+s.tackles*.30+s.tfl*.65+s.sacks*4.7+s.pressures*.22+s.intDef*6.2+s.passBreakups*.45+teamBonus;if(['OT','OG','C'].includes(p.pos))return base+(s.snaps||0)*.012-(s.sacksAllowed||0)*2.8-(s.pressuresAllowed||0)*.32+playerSchemeFit(p,t)*.22+teamBonus;if(p.pos==='K')return base+(s.fgMade||0)*1.5-Math.max(0,(s.fgAtt||0)-(s.fgMade||0))*.8+teamBonus;if(p.pos==='P')return base+(s.punts||0)*.12+(s.punts?(s.puntYds/s.punts-40)*1.4:0)+teamBonus;return base+playerSchemeFit(p,t)*.25+teamBonus}
...
function productionRating(p){let c=p.career||p.stats||{},v=50;if(p.pos==='QB')v+=(c.passYds||0)/650+(c.passTD||0)*.35-(c.int||0)*.12+(c.rushYds||0)/300+(c.rushTD||0)*.5;else if(p.pos==='RB')v+=(c.rushYds||0)/330+(c.rushTD||0)*.7+(c.recYds||0)/500+(c.recTD||0)*.45;else if(['WR','TE'].includes(p.pos))v+=(c.recYds||0)/350+(c.recTD||0)*.75;else if(['EDGE','DT','LB','CB','S'].includes(p.pos))v+=(c.tackles||0)/16+(c.tfl||0)*.25+(c.sacks||0)*1.8+(c.pressures||0)*.08+(c.intDef||0)*2.3+(c.passBreakups||0)*.12;else if(['OT','OG','C'].includes(p.pos))v+=(p.perceived||p.trueNow)*.18+(c.snaps||0)/700-(c.sacksAllowed||0)*.45-(c.pressuresAllowed||0)*.05;else if(p.pos==='K')v+=(c.fgMade||0)*.35-Math.max(0,(c.fgAtt||0)-(c.fgMade||0))*.25;else if(p.pos==='P')v+=(c.punts||0)?(c.puntYds/c.punts-38)*1.2:0;else v+=p.perceived*.28;return clamp(v,35,99)}
...
function earlyDeclaration(p,t){if(eligibilityBase(p)<2||eligibilityBase(p)>=3)return false;let d=draftProjection(p,t);return d.round&&d.round<=2&&gameplayRandom()<(d.round===1?.52:.24)}
...
function deriveRivalries(){
 ...
 const bind=(t,o,d)=>{
  ...
  setPrimaryRival(t,o);setPrimaryRival(o,t);
 };
 for(const t of teams){
  if(t.rivalry||!primaryRivalId(t))continue;
  const o=byId.get(primaryRivalId(t));
  if(o&&!o.rivalry&&o.id!==t.id&&o.conference===t.conference&&primaryRivalId(o)===t.id)bind(t,o,dist(t,o));
 }
 const pairs=[];
...
const RIVALRY_POSTSEASON_CAP=12;
function recordRivalryResult(t,won,ctx={}){
 ...
 // v0.9.48: who actually holds the trophy, the biggest win in the series, and the times
 // it was settled somewhere that mattered. Bounded, so a long dynasty cannot grow the save.
 s.holderId=won?t.id:(t.rivalry.rivalId??null);
 const margin=Number(ctx.margin);
 if(won&&Number.isFinite(margin)&&margin>(s.bestWin?.margin??-1))
  s.bestWin={year:universe.year,margin,score:ctx.score||null};
 if(ctx.label&&ctx.label!=='Regular season'){
  s.postseason??=[];
  s.postseason.push({year:universe.year,label:ctx.label,result:won?'W':'L',score:ctx.score||null});
  if(s.postseason.length>RIVALRY_POSTSEASON_CAP)s.postseason.splice(0,s.postseason.length-RIVALRY_POSTSEASON_CAP);
 }
}
function settleRivalryGame(g){
 ...
 const hs=g.score?.[1]??null,as=g.score?.[0]??null,gap=Number.isFinite(hs)&&Number.isFinite(as)?Math.abs(hs-as):null;
 const score=gap==null?null:`${as}-${hs}`,label=g.label||'Regular season';
 recordRivalryResult(home,homeWon,{margin:gap,score,label});
 recordRivalryResult(away,!homeWon,{margin:gap,score,label});
...
// v0.9.51: explicit season objectives turn the board's expectations into a visible contract.
function seasonGoalSeed(t){return (((universe.year||0)*131)+((t?.id||0)*17))>>>0}
...
function seasonGoalStatus(t,g,final=false){
 ...
 if(g.type==='conferenceTitle'){const done=conferenceChampionIdsFor().includes(t.id);return{state:done?'complete':final?'failed':'on_track',progress:done?'Conference champion':'Still alive'}}
...
function adminSeasonReview(t){
 ...
 const exp=seasonExpectation(t),diff=(t.w||0)-exp,
  ...
  goalReview=evaluateSeasonGoals(t,true),
  titleBonus=(t.champ?14:0)+(conferenceChampionIdsFor().includes(t.id)?6:0),
  delta=Math.round((diff*6*swing)+titleBonus+goalReview.adjustment);
 ...
 const review={year:universe.year,w:t.w||0,l:t.l||0,expected:exp,delta,before,after:t.adminConfidence,
  goalAdjustment:goalReview.adjustment,goals:goalReview.results,label:adminConfidenceLabel(t.adminConfidence)};
...
function bowlField(){
 const inPlayoff=new Set(seedField().map(t=>t.id));
 return ranked().filter(t=>bowlEligible(t)&&!inPlayoff.has(t.id));
}
...
function homeFieldScoreBonus(t,neutral=false){
 ...
 return base+(remainder>0&&gameplayRandom()<remainder/3?3:0);
}
...
function buildSigningDay(){
 ...
 for(const r of wavering){
  const from=r.committed,to=r.challenger,odds=signingDayOdds(r),flips=gameplayRandom()<odds&&canTakeCommit(to);
  ...
  if(flips&&decommitRecruit(r,'SIGNING_DAY_FLIP')){
   ...
   } else if(!commitRecruit(r,from)){
    // commitRecruit(r,from) can itself fail (a cap or block reached between the roll and
    // now) — the original school always has to take him back, since he was already
    // occupying that scholarship a moment ago. Restore directly rather than strand him.
    r.committed=from;r.commitWeek=universe.week;r.challenger=null;r.pressure=0;
    universe.recruitClassCounts[from]=classCommitCount(from)+1;
    const ft=T(from);if(ft){ft.commits??=[];ft.commits.push(r)}
   }
  }
  board.push(entry);
 }
...
// Academic standing changes at the shared start-of-week boundary, before either a quick
// simulation or a recorded Detailed/Interactive game can choose its participants.
function advanceAcademicsForWeek(t){
 if(!t)return [];
 let progress=universe.academicProgression;
 if(!progress||progress.season!==universe.year||progress.week!==universe.week||!Array.isArray(progress.teamIds))
  progress=universe.academicProgression={season:universe.year,week:universe.week,teamIds:[]};
 if(progress.teamIds.includes(t.id))return [];
 const holds=advanceAcademics(t);progress.teamIds.push(t.id);return holds;
}
...
function matchupEdges(off,def,O,D){const defScheme=DEF_SCHEMES[def.defScheme];return {
 passGame:Math.round(O.qb*.55+O.skill*.45-D.coverage),
 runGame:Math.round(O.ol*.62+O.skill*.38-(D.front*.78+defScheme.run*.22)),
 passProtection:Math.round(O.ol-(D.front*.80+defScheme.pressure*.20+(D.prepPressure||0)*100))
}}
function gameMatchup(team,opponent){const teamProfile=gameProfiles(team,opponent.name),opponentProfile=gameProfiles(opponent,team.name);return {team,opponent,teamProfile,opponentProfile,teamEdges:matchupEdges(team,opponent,teamProfile,opponentProfile),opponentEdges:matchupEdges(opponent,team,opponentProfile,teamProfile)}}
function gameplanRecommendation(team,opponent,matchup=gameMatchup(team,opponent)){const pass=OFF_SCHEMES[opponent.offScheme].pass,e=matchup.opponentEdges;if(pass>=.54){if(e.passProtection<=-4)return{id:'pressure',reason:`Their pass protection grades ${e.passProtection}; attack it before routes develop.`};return{id:'protect_pass',reason:`Their ${Math.round(pass*100)}% pass tendency makes coverage the larger threat.`}}if(pass<=.46)return{id:'stop_run',reason:`Their ${Math.round((1-pass)*100)}% run tendency puts the front at the center of the matchup.`};if(e.runGame>e.passGame+3)return{id:'stop_run',reason:`Their run-game edge (${e.runGame}) is stronger than their pass-game edge (${e.passGame}).`};if(e.passGame>e.runGame+3)return{id:'protect_pass',reason:`Their pass-game edge (${e.passGame}) is stronger than their run-game edge (${e.runGame}).`};return{id:'balance',reason:'Neither offensive matchup has a decisive edge.'}}
function matchupEdgeLabel(v){return v>=8?'Strong advantage':v>=3?'Advantage':v<=-8?'Major concern':v<=-3?'Disadvantage':'Even'}
...
function weeklyGameplanDecision(t){
 ...
 const passShare=OFF_SCHEMES[opp.offScheme].pass,analysis=gameMatchup(t,opp),recommendation=gameplanRecommendation(t,opp,analysis),staffPick=recommendation.id;
 ...
 return decisionRecord('WEEKLY_GAMEPLAN',t,null,`Gameplan for ${opp.name}`,
  `${opp.offScheme} / ${opp.defScheme} · ${opp.w}-${opp.l}. Scheme tendency: about ${Math.round(passShare*100)}% pass. ${recommendation.reason}`,
...
const GUIDANCE_STATE_VERSION=1,GUIDANCE_FAMILIARITY_MAX=3,GUIDANCE_RETURN_AFTER_MS=6*60*60*1000;
const GUIDANCE_CATEGORIES=new Set(['career','coach_desk','game_plan','roster_management','staffing','recruiting','monitoring']);
let guidanceReturnState=null;
function guidanceCalendarStamp(target=universe){
 const os=target?.phase==='complete'?(OFFSEASON_PHASES.includes(target?.offseason?.phase)?target.offseason.phase:'review'):'season';
 return `${target?.year??0}:${target?.phase||'none'}:${target?.week??0}:${os}`;
}
function normalizeGuidanceState(target=universe){
 const raw=target?.guidanceState,valid=raw?.version===GUIDANCE_STATE_VERSION&&raw.teams&&typeof raw.teams==='object'&&!Array.isArray(raw.teams),out={version:GUIDANCE_STATE_VERSION,teams:{}},currentStamp=guidanceCalendarStamp(target);
 for(const team of target?.teams||[]){
  const prior=valid&&raw.teams[String(team.id)]&&typeof raw.teams[String(team.id)]==='object'?raw.teams[String(team.id)]:{},familiarity={},deferred={};
  for(const category of GUIDANCE_CATEGORIES){const score=Number(prior.familiarity?.[category]);if(Number.isFinite(score)&&score>0)familiarity[category]=Math.min(GUIDANCE_FAMILIARITY_MAX,Math.floor(score))}
  for(const [id,record] of Object.entries(prior.deferred||{}).slice(-100))if(id.startsWith(`guidance:${team.id}:`)&&id.length<=240&&record?.stamp===currentStamp)deferred[id]={stamp:record.stamp};
  out.teams[String(team.id)]={familiarity,deferred};
 }
 target.guidanceState=out;return out;
}
function guidanceStateFor(t=selected(),target=universe){
 const state=target?.guidanceState?.version===GUIDANCE_STATE_VERSION?target.guidanceState.teams?.[String(t?.id)]:null;
 return state&&typeof state==='object'?state:{familiarity:{},deferred:{}};
}
function guidanceMutableStateFor(t=selected()){
 normalizeGuidanceState();return universe.guidanceState.teams[String(t.id)];
}
function guidanceRecordFamiliarity(category,t=selected()){
 if(!t||!GUIDANCE_CATEGORIES.has(category))return 0;
 const state=guidanceMutableStateFor(t),next=Math.min(GUIDANCE_FAMILIARITY_MAX,(Number(state.familiarity[category])||0)+1);
 state.familiarity[category]=next;autosaveAfter('guidance');return next;
}
function guidanceMarkFamiliar(id,t=selected()){
 const model=guidanceModel(t),item=[...(model.items||[]),...(model.snoozed||[])].find(x=>x.id===id);
 return item?guidanceRecordFamiliarity(item.category,t):0;
}
function snoozeGuidance(id,t=selected()){
 if(!t)return false;const item=guidanceModel(t).items.find(x=>x.id===id);
 if(!item||!['staff_recommendation','monitoring'].includes(item.meaning))return false;
 const state=guidanceMutableStateFor(t);state.deferred[id]={stamp:guidanceCalendarStamp()};autosaveAfter('guidance');return true;
}
function restoreGuidance(id,t=selected()){
 if(!t)return false;const state=guidanceMutableStateFor(t);if(!state.deferred[id])return false;
 delete state.deferred[id];autosaveAfter('guidance');return true;
}
function guidanceCurrentLabel(target=universe){
 if(openingPreseason(target))return `${target.year} preseason`;
 if(target?.phase==='regular')return `${target.year} · Week ${Number(target.week||0)+1}`;
 if(target?.phase==='complete')return `${target.year} offseason · ${guidanceOffseasonPhase()}`;
 return `${target?.year??''} · ${target?.phase||'dynasty'}`;
}
function guidanceWelcomeBack(savedAt,t=selected(),loadedAt=Date.now()){
 const saved=Date.parse(savedAt),elapsed=loadedAt-saved;if(!t||!Number.isFinite(saved)||!Number.isFinite(loadedAt)||elapsed<GUIDANCE_RETURN_AFTER_MS)return null;
 const model=guidanceModel(t),counts={required:model.items.filter(x=>x.meaning==='must_resolve').length,due:model.items.filter(x=>x.meaning==='decision_due').length,recommended:model.items.filter(x=>x.meaning==='staff_recommendation').length};
 return {kind:'guidance_return',savedAt,elapsedMs:elapsed,currentLabel:guidanceCurrentLabel(),boundary:{key:model.forecast?.key||'none',label:model.forecast?.label||'No advance available',status:model.forecast?.status||'ready'},counts,items:model.leading.slice(0,3).map(x=>({id:x.id,title:x.title,meaning:x.meaning}))};
}
function guidancePrepareReturn(savedAt){const loadedAt=Date.now();guidanceReturnState=guidanceWelcomeBack(savedAt,selected(),loadedAt)?{savedAt,loadedAt}:null;return guidanceReturnState}
function guidanceReturnSummary(){return guidanceReturnState?guidanceWelcomeBack(guidanceReturnState.savedAt,selected(),guidanceReturnState.loadedAt):null}
function dismissGuidanceReturnSummary(){guidanceReturnState=null;return true}
function guidanceDeferItem(id,t=selected()){return snoozeGuidance(id,t)}
function guidanceRestoreItem(id,t=selected()){return restoreGuidance(id,t)}
...
function guidanceModel(t=selected()){
 ...
 const state=guidanceStateFor(t),stamp=guidanceCalendarStamp();
 for(const item of items){item.familiarity=Number(state.familiarity?.[item.category])||0;item.deferred=['staff_recommendation','monitoring'].includes(item.meaning)&&state.deferred?.[item.id]?.stamp===stamp}
 ...
 const snoozed=items.filter(x=>x.deferred),activeItems=items.filter(x=>!x.deferred),blockers=activeItems.filter(x=>x.meaning==='must_resolve'),leading=blockers.concat(activeItems.filter(x=>x.meaning!=='must_resolve').slice(0,Math.max(0,3-blockers.length))),leadIds=new Set(leading.map(x=>x.id)),remaining=activeItems.filter(x=>!leadIds.has(x.id));
 ...
 return {items:activeItems,snoozed,leading,remaining,forecast,plan,quiet:!items.some(x=>x.meaning==='must_resolve'||x.meaning==='decision_due')};
}
...
function simPlayoff(){if(universe.phase==='bowlReady')simBowls();if(universe.phase!=='playoffReady')return;if(universe.playoffFieldUnavailable){setStatus('This older postseason save predates frozen playoff selections after its bowls. The original field is unavailable, so no playoff was simulated.');return}let field=seedField();if(field.length!==16){setStatus('The saved playoff field is incomplete, so no playoff was simulated.');return}field.forEach((t,i)=>t.seed=i+1);let logs=[];function round(arr,label){let out=[];for(let i=0;i<arr.length/2;i++){let a=arr[i],b=arr[arr.length-1-i],r=gameSim(a,b,true,false,{week:14+['Round of 16','Quarterfinal','Semifinal','National Championship'].indexOf(label),label});logs.push({...r,label});out.push(T(r.winner))}return out}let r16=round(field,'Round of 16'),q=round(r16,'Quarterfinal'),s=round(q,'Semifinal'),f=round(s,'National Championship');universe.champion=f[0].name;universe.phase='complete';universe.offseason=makeOffseasonState(universe.year,'review');universe.latest=logs;finalizeRecruiting();finalizeSeasonHonors();archiveSeason();ranked();autosaveAfter('postseason');render()}
...
// Signing day flips/stays can be given a `protect` set of recruit ids so a scholarship
// cleanup moments later in the same cycle cannot undo what the board just told the
// player happened to them.
function enforceScholarshipLimits(protect=null){
 for(const t of universe.teams){
  let guard=0;
  while(classCommitCount(t.name)>scholarshipCapacity(t)&&guard++<40){
   const commits=universe.recruits.filter(r=>r.committed===t.name&&!(protect&&protect.has(r.id)));
...
function carousel(){
 ...
 for(const t of universe.teams){const hc=t.staff.HC,expected=clamp(Math.round((t.prestige-30)/8),4,10),bad=t.w<expected-2,fire=bad&&gameplayRandom()>(t.admin_patience/100),hcRetire=gameplayRandom()<coachRetirementChance(hc);if(!(fire||hcRetire))continue;const status=hcRetire?'RETIRED':'FIRED',reason=hcRetire?'Retired after the season':`Fired after ${t.w}-${t.l}`;if(t.name===controlled){createOpening(t,'HC',reason,status);mark(t,'HC');log.push(`${t.name}: ${hc.name} ${status==='FIRED'?'was fired':'retired'}. The Head Coach job is open — interview and hire from the Staff tab.`);continue}const candidates=['OC','DC'].filter(slot=>!did(t,slot)).map(slot=>({slot,c:t.staff[slot],score:(t.staff[slot].ambition||60)+(t.staff[slot].playCall||60)*.35+(t.staff[slot].development||60)*.2})).sort((a,b)=>b.score-a.score),promote=gameplayRandom()<.32&&candidates[0]?.c;if(promote){const who=candidates[0],oldName=hc.name;promoteCoachWithinTeam(t,who.slot,'HC',reason,status);mark(t,'HC');mark(t,who.slot);moved.add(who.c.id);log.push(`${t.name}: ${oldName} ${status==='FIRED'?'was fired':'retired'}; ${who.c.name} promoted from ${COACH_SLOT_ROLES[who.slot]} to Head Coach.`)}else{const x=replaceStaffCoach(t,'HC',reason,status,next);mark(t,'HC');log.push(`${t.name}: ${x.old.name} ${status==='FIRED'?'was fired':'retired'}; ${x.fresh.name} hired as Head Coach.`)}}
 for(const t of universe.teams)for(const slot of ['OC','DC']){if(did(t,slot))continue;const c=t.staff[slot];if(moved.has(c.id))continue;const retire=gameplayRandom()<coachRetirementChance(c),turn=!retire&&gameplayRandom()<(slot==='OC'?.07+c.ambition/900:.06+c.ambition/1000);if(!retire&&!turn)continue;if(t.name===controlled){createOpening(t,slot,retire?'Retired after the season':'Left for another opportunity',retire?'RETIRED':'DEPARTED');mark(t,slot);log.push(`${t.name}: ${c.name} ${retire?'retired':'left for another opportunity'} as ${COACH_SLOT_ROLES[slot]}. The job is open — interview and hire from the Staff tab.`);continue}if(retire){const x=replaceStaffCoach(t,slot,'Retired after the season','RETIRED',next);mark(t,slot);log.push(`${t.name}: ${x.old.name} retired; ${x.fresh.name} takes over as ${COACH_SLOT_ROLES[slot]}.`);continue}const dest=trackedMoves<6?chooseCoachMoveDestination(c,t,slot,changed,moved):null;if(dest){const destOld=dest.staff[slot].name;moveCoach(c,t,dest,slot,'Accepted a new coordinator job');mark(t,slot);mark(dest,slot);moved.add(c.id);trackedMoves++;log.push(`${c.name}: ${t.name} ${COACH_SLOT_ROLES[slot]} → ${dest.name} ${COACH_SLOT_ROLES[slot]}; ${destOld} departs.`)}else{const x=replaceStaffCoach(t,slot,'Left for another opportunity','DEPARTED',next);mark(t,slot);log.push(`${t.name}: ${x.old.name} left as ${COACH_SLOT_ROLES[slot]}; ${x.fresh.name} takes over.`)}}
 for(const t of universe.teams){if(!did(t,'RC')){const c=t.staff.RC,retire=gameplayRandom()<coachRetirementChance(c),turn=!retire&&gameplayRandom()<.018+(c.ambition||60)/2200;if(t.name===controlled){if(retire||turn){createOpening(t,'RC',retire?'Retired after the season':'Left for another opportunity',retire?'RETIRED':'DEPARTED');mark(t,'RC');log.push(`${t.name}: ${c.name} ${retire?'retired':'left for another opportunity'} as Recruiting Coordinator. The job is open — interview and hire from the Staff tab.`)}}else if(retire){const x=replaceStaffCoach(t,'RC','Retired after the season','RETIRED',next);mark(t,'RC');log.push(`${t.name}: ${x.old.name} retired; ${x.fresh.name} takes over as Recruiting Coordinator.`)}else if(turn){const dest=trackedMoves<8?chooseCoachMoveDestination(c,t,'RC',changed,moved):null;if(dest){const destOld=dest.staff.RC.name;moveCoach(c,t,dest,'RC','Accepted a new recruiting coordinator job');mark(t,'RC');mark(dest,'RC');moved.add(c.id);trackedMoves++;log.push(`${c.name}: ${t.name} Recruiting Coordinator → ${dest.name}; ${destOld} departs.`)}else{const x=replaceStaffCoach(t,'RC','Left for another opportunity','DEPARTED',next);mark(t,'RC');log.push(`${t.name}: ${x.old.name} left as Recruiting Coordinator; ${x.fresh.name} takes over.`)}}}if(!did(t,'SC')){const c=t.staff.SC;if(gameplayRandom()<coachRetirementChance(c)){if(t.name===controlled){createOpening(t,'SC','Retired after the season','RETIRED');mark(t,'SC');log.push(`${t.name}: ${c.name} retired as Strength & Performance. The job is open — interview and hire from the Staff tab.`)}else{const x=replaceStaffCoach(t,'SC','Retired after the season','RETIRED',next);mark(t,'SC');log.push(`${t.name}: ${x.old.name} retired; ${x.fresh.name} takes over as Strength & Performance.`)}}}}
 return log
}
function offseasonPhaseDone(phase){
 return normalizeOffseasonState().completed.includes(phase);
}
function finishOffseasonPhase(phase,next,report={}){
 const os=normalizeOffseasonState();
 if(!os.completed.includes(phase))os.completed.push(phase);
 os.reports[phase]=report;
 os.phase=next;
 return os;
}
function offseasonReview(){
 const os=normalizeOffseasonState();
 if(offseasonPhaseDone('review')){if(os.phase==='review')os.phase='departures';return true}
 auditPromises();finalizeSeasonHonors();archiveSeason();reviewControlledProgram(selected());creditCoachingTree(selected());
 for(const t of universe.teams)updateFanSupport(t);
 const carouselLog=carousel(),controlled=$('#userTeam').value;
 const meanPrestige=avg(universe.teams.map(t=>t.prestige)),meanWins=avg(universe.teams.map(t=>t.w)),teams={};
 for(const t of universe.teams){
  ensureAllTimeRecord(t);
  recordSeasonInHistory(t,t.w,t.l,conferenceChampionIdsFor().includes(t.id),universe.champion===t.name);
  for(const p of t.roster)archivePlayerSeason(p,t,universe.year);
  const target=meanWins+(t.prestige-meanPrestige)/9,prestigeDelta=clamp(Math.round((t.w-target)*.35),-3,3);
  t.prestige=clamp(t.prestige+prestigeDelta,10,t.program_ceiling);
  teams[t.id]={prestigeDelta,record:`${t.w}-${t.l}`};
 }
 finishOffseasonPhase('review','departures',{carouselLog,controlled,teams});
 return true;
}
function offseasonDepartures(){
 const os=normalizeOffseasonState();
 if(offseasonPhaseDone('departures')){if(os.phase==='departures')os.phase='signing';return true}
 const controlled=$('#userTeam').value,portal=[...(universe.transferPortal||[])],draftPool=[],teams={};
 universe.transferPortal=[];
 for(const t of universe.teams){
  const exits=[];
  for(const p of t.roster){
   if(t.name===controlled&&eligibilityBase(p)===0)snapshotScouting(p,t,'FRESHMAN_YEAR_END','SEASON');
   const preserved=p.redshirtActive&&canRedshirt(p)&&(p.stats?.games||0)<=4;
   if(preserved){p.redshirtUsed=true;p.redshirtSeason=universe.year;p.redshirtActive=false}
   else{p.redshirtActive=false;p.eligibilityUsed=eligibilityBase(p)+1}
   const exhausted=p.eligibilityUsed>=4,early=!exhausted&&earlyDeclaration(p,t);
   if(exhausted||early){const reason=early?'Declared early for draft':'Eligibility exhausted';draftPool.push({p,teamId:t.id,reason,score:draftProjection(p,t).score});exits.push(p)}
  }
  t.roster=t.roster.filter(p=>!exits.includes(p));
  const keep=[];
  for(const p of t.roster){
   const reason=transferPortalEntryReason(p);
   if(reason)portal.push(ensurePortalEntry({p,from:t.name,fromSchoolId:t.id,reason,enteredSeason:universe.year,wasStarter:(p.stats?.starts||0)>=6}));
   else keep.push(p);
  }
  t.roster=keep;
  t.roster.forEach(p=>{ensurePlayerDevelopment(p,t);const old=p.perceived;p.morale=clamp(p.morale+gi(-5,9),15,99);p.promiseBaseline??=old;p.year=CLASS_NAMES[Math.min(3,eligibilityBase(p))]||'SR';p.positionFamiliarity[p.pos]=clamp(familiarity(p,p.pos)+gi(2,6),0,100);p.stats=newStats();p.campGrade=null});
  teams[t.id]={exits:exits.length,portal:portal.filter(x=>x.fromSchoolId===t.id).length};
 }
 universe.transferPortal=portal;
 finishOffseasonPhase('departures','signing',{draftPool,teams});
 return true;
}
function offseasonEnrollment(){
 const os=normalizeOffseasonState();
 if(offseasonPhaseDone('signing')){if(os.phase==='signing')os.phase='portal';return true}
 const controlled=$('#userTeam').value,teams={};
 for(const t of universe.teams){
  const signed=universe.recruits.filter(r=>r.committed===t.name).slice(0,Math.max(0,105-t.roster.length));
  signed.forEach(r=>{
   if(t.name===controlled){firstRecruitEvaluation(r,t);snapshotScouting(r,t,'SIGNING_DAY','RECRUITING',true)}
   const p=generatePlayer(t,r.pos,99);
   Object.assign(p,{name:r.name,style:r.style,trueNow:r.trueNow,upside:r.upside,perceived:r.scout,perceivedUpside:r.scoutUp,year:'FR',eligibilityUsed:0,redshirtUsed:false,redshirtActive:false,origin:`${r.stars}-star recruit from ${r.highSchool||r.homeRegion} (${r.homeCity||r.homeRegion}, ${r.homeState||''})${r.flippedFrom?` · flipped from ${r.flippedFrom}`:''}`,promise:r.promise&&r.promise!=='None'?r.promise:null,promiseBaseline:r.scout,portraitSeed:r.portraitSeed||p.portraitSeed,portraitVersion:r.portraitVersion||PORTRAIT_VERSION,scoutConfidence:r.scoutConfidence??p.scoutConfidence,scoutingDomains:r.scoutingDomains?JSON.parse(JSON.stringify(r.scoutingDomains)):undefined,scoutingHistory:r.scoutingHistory?JSON.parse(JSON.stringify(r.scoutingHistory)):[]});
   p.jerseyNumber=jerseyFor(p.pos,p.portraitSeed);signPlayerPromise(p,r,t);const developmentPromise=(p.promises||[]).find(q=>q.type==='DEVELOPMENT_PLAN'&&q.status==='ACTIVE');if(developmentPromise)p.trainingFocus=developmentPromise.expectedFocus;p.recruitingMemory=r.recruitingMemory;p.primaryRecruiterCoachId=r.primaryRecruiterCoachId||r.recruitingMemory?.primaryRecruiterCoachId||r.recruitingMemory?.recruiterCoachId||null;p.coachRelationships={...(r.coachRelationships||r.recruitingMemory?.coachRelationships||{})};p.coachDeparturePressure=r.coachDeparturePressure?{...r.coachDeparturePressure}:null;p.transferHistory=[];ensurePlayerDevelopment(p,t);t.roster.push(p);
   const hs=(universe.highSchools||[]).find(h=>h.id===r.highSchoolId);if(hs)hs.d1Signees=(hs.d1Signees||0)+1;
   t.pipelines[r.homeRegion]=clamp(pipelineStrength(t,r.homeRegion)+gi(1,3),0,100);
  });
  for(const c of Object.keys(t.pipelines))if(!signed.some(r=>r.homeRegion===c))t.pipelines[c]=clamp(t.pipelines[c]-1,5,100);
  teams[t.id]={signed:signed.length};
 }
 const movement=[];
 const departures=os.reports.departures?.teams||{},review=os.reports.review?.teams||{};
 const controlledTeam=universe.teams.find(t=>t.name===controlled);
 if(controlledTeam){
  const d=departures[controlledTeam.id]?.exits||0,s=teams[controlledTeam.id]?.signed||0,p=review[controlledTeam.id]?.prestigeDelta||0;
  movement.push(`${d} players left for the draft/eligibility; ${s} signees joined; ${p>=0?'+':''}${p} prestige.`);
 }
 os.reports.movement=movement;
 autosaveAfter('signing'),finishOffseasonPhase('signing','portal',teams);
 return true;
}
function offseasonPortal(){
 const os=normalizeOffseasonState();
 if(offseasonPhaseDone('portal')){if(os.phase==='portal')os.phase='spring';return true}
 const controlled=$('#userTeam').value,movement=[...(os.reports.movement||[])];
 const draftPool=(os.reports.departures?.draftPool||[]).map(d=>({...d,t:universe.teams.find(x=>x.id===d.teamId)||d.t}));runDraft(draftPool);
 const portal=[...(universe.transferPortal||[])];universe.transferPortal=[];
 portal.forEach(x=>{x.p.stats=newStats();x.p.year=CLASS_NAMES[Math.min(3,eligibilityBase(x.p))]||'SR';const dest=placeTransfer(x);if(dest){if(x.from===controlled||dest.name===controlled)movement.push(`${x.p.pos} ${x.p.name}: ${x.from} → ${dest.name} (${transferReasonLabel(x.reason)})`)}else universe.transferPortal.push(x)});
 updateCareerRecords();
 movement.push(...(os.reports.review?.carouselLog||[]).filter(x=>x.includes(controlled)));
 universe.movementLog=movement.slice(0,100);
 autosaveAfter('portal'),finishOffseasonPhase('portal','spring',{placed:portal.length-universe.transferPortal.length,pending:universe.transferPortal.length});
 return true;
}
function offseasonPreseason(){
 ...
 universe.year++;universe.week=0;resetNilSeason();universe.recoveredWeek=-1;universe.phase='regular';universe.latest=[];universe.confChamps=[];universe.playoffFieldIds=[];universe.playoffFieldUnavailable=false;universe.academicProgression={season:universe.year,week:0,teamIds:[]};universe.champion=null;universe.lastDetailedGame=null;universe.recruits=generateRecruitPool(2800,universe.highSchools);universe.recruitClassCounts={};
...
function advanceOffseasonPhase(){
 ...
 if(os.phase==='portal')return offseasonPortal();
 if(os.phase==='preseason')return offseasonPreseason();
 setStatus(os.phase==='spring'?'Run spring development next.':'Run fall camp next.');
 return false;
}
function advanceOffseasonTo(target){
 for(let i=0;i<OFFSEASON_PHASES.length&&universe.phase==='complete'&&normalizeOffseasonState().phase!==target;i++)if(!advanceOffseasonPhase())break;
 return normalizeOffseasonState().phase===target;
}
const runPreCalendarSpringCamp=runSpringCamp,runPreCalendarFallCamp=runFallCamp;
function calendarSpringCamp(){
 if(universe.phase!=='complete'){setStatus('Finish the season before spring development.');return}
 if(archiveIsDeferred())return storageOperation(async()=>{await ensureArchiveLoaded();calendarSpringCamp()});
 if(!advanceOffseasonTo('spring'))return;
 const os=normalizeOffseasonState();
 if(offseasonPhaseDone('spring')){os.phase='fall';render();return}
 runPreCalendarSpringCamp();
 if(ensureDevelopmentState().springRun)developmentResultsPhase='SPRING',developmentResultsFilter='ALL',autosaveAfter('camp'),finishOffseasonPhase('spring','fall',{rosterSize:universe.teams.reduce((n,t)=>n+t.roster.length,0)});
 render();
}
function calendarFallCamp(){
 if(universe.phase!=='complete'){setStatus('Finish the season before fall camp.');return}
 const os=normalizeOffseasonState();
 if(os.phase==='spring'){setStatus('Run spring development first.');return}
 if(os.phase!=='fall'){setStatus('Complete the earlier offseason phases first.');return}
 if(offseasonPhaseDone('fall')){os.phase='preseason';render();return}
 runPreCalendarFallCamp();
 if(ensureDevelopmentState().fallRun)developmentResultsPhase='FALL',developmentResultsFilter='ALL',autosaveAfter('camp'),finishOffseasonPhase('fall','preseason',{rosterSize:universe.teams.reduce((n,t)=>n+t.roster.length,0)});
 render();
}
...
// --- Transfer portal cycle (v0.9.47 commit 1: state + migration only) ---------
// The portal entry keeps owning its player record; nothing here copies p.
const PORTAL_ROUNDS=3,PORTAL_LOG_CAP=60,PORTAL_TARGET_CAP=8,PORTAL_STATUSES=['idle','open','resolved'];
// Stable across reloads and rounds: a player can only be in the portal once per season.
function portalCandidateId(entry){return `portal-${entry.enteredSeason??universe.year}-${entry.p?.id}`}
function ensurePortalEntry(entry){
...
function ensurePortalCycle(){
 let c=universe.portalCycle;
 // A cycle belongs to one season; a rollover starts a clean one rather than carrying targets forward.
 if(!c||typeof c!=='object'||c.year!==universe.year)c=universe.portalCycle=newPortalCycle(universe.year);
 c.targets=Array.isArray(c.targets)?c.targets.slice(0,PORTAL_TARGET_CAP):[];
 c.resolutions=Array.isArray(c.resolutions)?c.resolutions:[];
 c.log=Array.isArray(c.log)?c.log.slice(-PORTAL_LOG_CAP):[];
 c.round=clamp(Math.round(Number(c.round)||0),0,PORTAL_ROUNDS);
 if(!PORTAL_STATUSES.includes(c.status))c.status='idle';
 return c;
}
...
function portalResolveEntry(entry){
 ...
 let roll=gameplayRandom()*total,pick=pool.at(-1);
...
function resolvePortalCommitments(){
 ...
 if(placed.length){autosaveAfter('portal');portalLog(`${placed.length} portal commitment${placed.length===1?'':'s'} finalized.`)}
...
function advancePortalRound(){
 ...
 for(const entry of portalCandidates()){
  ...
  if(gameplayRandom()<portalCommitChance(c.round)){
...
function chooseTransferDestination(p,from,reason){
 ...
 let roll=gameplayRandom()*total;for(const x of candidates){roll-=x.weight;if(roll<=0)return x}return candidates.at(-1);
}
...
const TRANSFER_MORALE_PIVOT=70,TRANSFER_ENTRY_DIVISOR=360;
function transferRisk(p){return clamp((TRANSFER_MORALE_PIVOT-p.morale)+(p.role==='Development'?12:0)+(p.role==='Redshirt candidate'?8:0)+promisePenalty(p)+coachTransferPressure(p)+schemeFitPressure(p)+(p.injuryWeeks>3?3:0)-nilRetentionRelief(p),0,100)}
function transferPortalEntryReason(p,roll=gameplayRandom()){return roll<transferRisk(p)/TRANSFER_ENTRY_DIVISOR?transferReason(p):null}
...
function renderNewsletter(){
 ...
 if(letter.items.length)html+=`<div class="card"><h3>Around the ${letter.scope==='national'?'country':letter.scope==='conference'?'conference':'schedule'}</h3>${letter.items.map(x=>`<div class="news-item"><div class="strong">${gameEscape(newsScoreLine(x.game))}</div><div class="compact muted">${x.recap.body}</div><div>${gameLink(x.game.id,'Box score','Box Score')}</div></div>`).join('')}${letter.more?`<div class="small muted">${letter.more} more game${letter.more===1?'':'s'} not shown.</div>`:''}</div>`;
...
// This is presentation only: it never reads or writes simulation state.
const TEAM_LOGO_ATLAS='assets/team-logos-atlas-32.png',TEAM_LOGO_COLS=12,TEAM_LOGO_ROWS=10;
function commissionerMode(){return universe?.mode==='commissioner'}
function legacyControlMode(save,u){
 const controlled=save?.userTeam,careerSchool=u?.tenure?.school;
 // Before modes existed, changing the selector did not update the active
 // tenure until the next offseason. That mismatch is durable evidence that
 // the save used direct team switching and should retain the old controls.
 return controlled&&careerSchool&&controlled!==careerSchool?'commissioner':'dynasty';
}
function renderControlMode(){
 const commissioner=commissionerMode(),selector=$('#userTeam'),banner=$('#controlModeBanner');
 if(selector){selector.disabled=!commissioner;selector.title=commissioner?'Commissioner Mode: switch controlled program':'Dynasty Mode: change programs only through career offers'}
 if(banner){banner.hidden=!commissioner;banner.textContent='COMMISSIONER MODE · Program switching and direct institutional editing are enabled.'}
 for(const id of ['editName','editConference','editPrestige','editResources','editNil','editDevelopment','editFacilities','editAcademics','applyProgramEdit'])if($('#'+id))$('#'+id).disabled=!commissioner;
 const note=$('#programEditNotice');if(note)note.textContent=commissioner?'Commissioner controls are active. Changes alter the live universe.':'Dynasty Mode locks institutional editing. Build the program through results, staff and future investments.';
}
function teamLogoHTML(teamId,size=24,extraClass=''){
 const id=Number(teamId);
 if(!Number.isInteger(id)||id<1||id>120)
  return `<span class="team-logo team-logo--fallback ${extraClass}" style="width:${size}px;height:${size}px" aria-hidden="true"></span>`;
...
function render(){
 ...
 $('#teamName').textContent=u.name;const mm=$('.masthead-mark');if(mm){mm.innerHTML=teamLogoHTML(u.id,48);mm.classList.add('has-logo')}
 $('#teamMeta').textContent=`${u.conference} · ${u.offScheme} / ${u.defScheme} · Prestige ${u.prestige} · Ceiling ${u.program_ceiling}`;
 $('#teamMetrics').innerHTML=[['Offense',grade(p.offense)],['Defense',grade(p.defense)],['Scheme Fit',grade((p.offFit+p.defFit)/2)],['Development',grade(u.development)]].map(x=>`<div class="metric"><div class="small muted">${x[0]}</div><div class="v">${x[1]}</div></div>`).join('');
...
function weeklyPlan(u){
 ...
 if(openingPreseason())
  out.push(planStep('begin','Begin season','Your schedule is ready. Start Week 1 when your setup feels right.','dashboard',false,100));
 else if(phase==='regular'&&universe.week<12)
  ...
  const os=normalizeOffseasonState(),labels={review:'Run season review',departures:'Process departures',signing:'Enroll the signing class',portal:'Resolve the transfer portal',spring:'Run spring development',fall:'Run fall camp',preseason:'Open the new season'},details={review:'Finalize records, honors, administration and coaching.',departures:'Graduates, declarations and portal entrants leave first.',signing:'Committed freshmen join the post-departure roster.',portal:'Place transfers before either development window.',spring:'Develop the actual returning and incoming roster.',fall:'Settle position battles on the opening-day roster.',preseason:'Reset the calendar, schedules and recruiting pool.'};
  OFFSEASON_PHASES.forEach((key,i)=>out.push(planStep(key,labels[key],details[key],['spring','fall'].includes(key)?'development':'offseason',os.completed.includes(key),100-i)));
 }
 ...
 if(sch.over)
  out.push(planStep('over','Scholarship limit warning',`${sch.over} over. This does not block postseason; signing day will pull your weakest commitments for you.`,'recruiting',false,92));
 // 3. Recruiting work that is actually available this week.
 const targets=universe.recruits.filter(r=>r.targeted&&!r.committed).length;
 if(sch.room>0&&(phase==='regular'||openingPreseason()))
 ...
 return {items,remaining:items.filter(x=>!x.done).length,
  heading:phase==='complete'?'Offseason checklist'
   ...
   :openingPreseason()?'Preseason setup'
...
function renderWeeklyHub(){universe.weeklyHub=[...familiarFaceItems(selected()),...(universe.weeklyHub||[]).filter(x=>x.kicker!=='FAMILIAR FACE')].slice(0,9);let hub=universe.weeklyHub||[];$('#hubTitle').textContent=openingPreseason()?'Preseason Briefing':universe.week===0?'Week 1 Briefing':`Week ${universe.week} Briefing`;if(!hub.length)buildPreseasonHub();$('#weeklyHub').innerHTML=(universe.weeklyHub||[]).map((x,i)=>`<div class="hub-item ${x.type||''}${x.tab?' hub-link':''}"${x.tab?` data-hub="${i}" data-tab="${x.tab}"${x.gameId?` data-game-id="${gameEscape(x.gameId)}"`:''} role="button" tabindex="0"`:''}><div class="hub-kicker">${x.kicker}</div><div class="hub-main">${x.main}</div><div class="hub-sub">${x.sub||''}</div></div>`).join('');$$('[data-hub]').forEach(el=>{const go=()=>openHubItem((universe.weeklyHub||[])[+el.dataset.hub]);el.onclick=go;el.onkeydown=e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();go()}}})}
...
function renderGameLab(){
 const u=selected(),g=findUserGame();
 if(g){
  const opp=T(g.home===u.name?g.away:g.home),P=profiles(u),O=profiles(opp);
  $('#nextGameCard').innerHTML=`<strong>Week ${universe.week+1}: ${g.home===u.name?'vs':'@'} ${opp.name}</strong><div class="muted">${u.name}: O ${grade(P.offense)} / D ${grade(P.defense)} · ${opp.name}: O ${grade(O.offense)} / D ${grade(O.defense)}</div>`;
  $('#keyMatchups').innerHTML=`<div class="lineitem"><span>Your QB vs their coverage</span><strong>${grade(P.qb)} vs ${grade(O.coverage)}</strong></div><div class="lineitem"><span>Your OL vs their front</span><strong>${grade(P.ol)} vs ${grade(O.front)}</strong></div><div class="lineitem"><span>Your scheme fit</span><strong>${grade(P.offFit)}</strong></div><div class="lineitem"><span>Their scheme fit</span><strong>${grade(O.offFit)}</strong></div>`;
 }else $('#nextGameCard').innerHTML=openingPreseason()?'<strong>Week 1 is waiting.</strong><div class="muted">Finish your preseason setup, then choose Begin Season in the Command Center to unlock this matchup.</div>':'<span class="muted">No unsimulated user game in the current regular-season week.</span>';
 const d=universe.lastDetailedGame;
 if(d){
  $('#detailedBox').innerHTML=`${gameResultActions(d.gameId)}${d.season?`<div class="small muted">${d.season} · Week ${d.week}</div>`:''}<div class="big">${d.away} ${d.ap} – ${d.hp} ${d.home}</div><div class="lineitem"><span>${d.away} total offense</span><strong>${d.box.away.passYds+d.box.away.rushYds}</strong></div><div class="lineitem"><span>${d.home} total offense</span><strong>${d.box.home.passYds+d.box.home.rushYds}</strong></div><div class="lineitem"><span>Turnovers</span><strong>${d.box.away.turnovers} – ${d.box.home.turnovers}</strong></div>`;
  $('#detailedLog').innerHTML=d.log.slice().reverse().map(x=>`<div class="playline">${x}</div>`).join('');
 }else{$('#detailedBox').textContent='No detailed game simulated yet.';$('#detailedLog').textContent='No detailed game simulated yet.'}
}
function renderMatchupStrategy(){
 const u=selected(),g=findUserGame();if(!g)return;
 const opp=T(g.home===u.name?g.away:g.home),m=gameMatchup(u,opp),P=m.teamProfile,O=m.opponentProfile,e=m.teamEdges,oe=m.opponentEdges,
  plan=teamGameplanFor(u,opp.name),tier=GAMEPLAN_TIERS[plan?.prep]||GAMEPLAN_TIERS.standard,rec=gameplanRecommendation(u,opp,m),
  isHome=g.home===u.name,homeTeam=isHome?u:opp,home=isHome?`Home field: about +${homeFieldFor(u).toFixed(1)} points`:'Road game: opponent receives its home-field edge',
  outU=u.roster.filter(p=>!gameAvailable(p)).length,outO=opp.roster.filter(p=>!gameAvailable(p)).length,
  rival=rivalOf(u),isRival=rival?.name===opp.name,sameConference=u.conference===opp.conference,
  stakes=isRival?`${u.rivalry?.trophy||'Rivalry game'} · ${rivalrySeriesText(u)}`:sameConference?`${u.conference} Conference game`:'Nonconference game',
  venue=`${homeTeam.city}, ${homeTeam.state}`,
  rankLabel=t=>t.rank<=25?`#${t.rank}`:'NR',
  row=(label,value)=>`<div class="lineitem"><span>${label}</span><strong class="${value>=3?'good':value<=-3?'bad':''}">${matchupEdgeLabel(value)} (${value>=0?'+':''}${value})</strong></div>`;
 $('#nextGameCard').innerHTML=`<div class="gameday-data" hidden data-week="${universe.week+1}" data-location="${isHome?'vs':'@'}" data-user-id="${u.id}" data-opponent-id="${opp.id}" data-user-name="${gameEscape(u.name)}" data-opponent-name="${gameEscape(opp.name)}" data-user-record="${u.w}-${u.l}" data-opponent-record="${opp.w}-${opp.l}" data-user-rank="${rankLabel(u)}" data-opponent-rank="${rankLabel(opp)}" data-user-conference="${gameEscape(u.conference)}" data-opponent-conference="${gameEscape(opp.conference)}" data-venue="${gameEscape(venue)}" data-stakes="${gameEscape(stakes)}" data-rivalry="${isRival?'true':'false'}" data-user-offense="${grade(P.offense)}" data-user-defense="${grade(P.defense)}" data-opponent-offense="${grade(O.offense)}" data-opponent-defense="${grade(O.defense)}" data-opponent-pass-mix="${Math.round(OFF_SCHEMES[opp.offScheme].pass*100)}" data-home-edge="${gameEscape(home)}" data-user-out="${outU}" data-opponent-out="${outO}" data-active-plan="${gameEscape(tier.label)}" data-recommended-plan="${gameEscape(GAMEPLAN_TIERS[rec.id].label)}" data-recommendation="${gameEscape(rec.reason)}"></div><strong>Week ${universe.week+1}: ${isHome?'vs':'@'} ${gameEscape(opp.name)}</strong><div class="muted">${gameEscape(u.name)}: O ${grade(P.offense)} / D ${grade(P.defense)} · ${gameEscape(opp.name)}: O ${grade(O.offense)} / D ${grade(O.defense)}</div><div class="small muted">Expected opponent mix: ${Math.round(OFF_SCHEMES[opp.offScheme].pass*100)}% pass · ${home} · unavailable: ${outU} yours / ${outO} theirs</div><div class="small"><strong>Active plan:</strong> ${tier.label}. <strong>Staff recommendation:</strong> ${GAMEPLAN_TIERS[rec.id].label} — ${rec.reason}</div>`;
 $('#keyMatchups').innerHTML=`${row('Your passing game vs their coverage',e.passGame)}${row('Your run game vs their front',e.runGame)}${row('Your pass protection vs their rush',e.passProtection)}${row('Their passing game vs your coverage',oe.passGame)}${row('Their run game vs your front',oe.runGame)}${row('Their protection vs your rush',oe.passProtection)}<div class="small muted">These edges use the same current profiles consumed at kickoff, including health, wear, scheme, staff and the active gameplan.</div>`
}
TAB_RENDERERS.gamelab=()=>{renderGameLab();renderMatchupStrategy()};
function renderSeason(){const u=selected();$('#seasonPhase').textContent=openingPreseason()?`${universe.year} · Preseason`:`${universe.year} · ${universe.phase} · Week ${universe.week}`;$('#confStandings').innerHTML=confStand(u.conference).map((t,i)=>`<div class="rankrow ${t.name===u.name?'strong':''}"><div>${i+1}. ${teamLogoHTML(t.id,20,'team-logo--inline')} ${t.name}</div><div>${t.cw}-${t.cl} · ${t.w}-${t.l}</div></div>`).join('');$('#latestResults').innerHTML=universe.latest.length?universe.latest.slice(-12).reverse().map(r=>`<div class="resultrow ${r.label?'champ':''}"><div>${r.label?`<span class="small muted">${r.label}</span><br>`:''}${teamLogoHTML(T(r.away)?.id,18,'team-logo--inline')} ${r.away}</div><div><strong>${r.ap}</strong> – <strong>${r.hp}</strong> ${teamLogoHTML(T(r.home)?.id,18,'team-logo--inline')} ${r.home} ${gameLink(r.gameId)}</div></div>`).join(''):'<div class="muted">No results yet.</div>';$('#teamSchedule').innerHTML=u.schedule.map(g=>{let opp=g.home===u.name?g.away:g.home,loc=g.home===u.name?'vs':'@',score=g.played?`${g.score[0]}-${g.score[1]}`:'—';return `<div class="resultrow"><div>Wk ${g.week} · ${loc} ${teamLogoHTML(T(opp)?.id,18,'team-logo--inline')} ${opp}${g.detailed?' <span class="pill">Detailed</span>':''}</div><div>${g.played?gameLink(g.gameId,`${g.winner===u.name?'W':'L'} ${g.home===u.name?g.score[1]:g.score[0]}–${g.home===u.name?g.score[0]:g.score[1]}`):score}</div></div>`}).join('')}
...
function renderProgram(){const u=selected();ensureSeasonGoals(u);$('#programOverview')&&($('#programOverview').innerHTML=programOverviewHTML(u));$('#programGoals')&&($('#programGoals').innerHTML=seasonGoalsHTML(u));$('#editName').value=u.name;$('#editConference').value=u.conference;$('#editPrestige').value=u.prestige;$('#editResources').value=u.resources;$('#editNil').value=u.nil;$('#editDevelopment').value=u.development;$('#editFacilities').value=u.facilities;$('#editAcademics').value=u.academics;$('#careerHistory')&&($('#careerHistory').innerHTML=careerHistoryHTML());renderCareerPost();$('#programHistory')&&($('#programHistory').innerHTML=programHistoryHTML(selected()));$('#programDNA').innerHTML=[['Prestige',u.prestige],['Resources',u.resources],['NIL',u.nil],['Development',u.development],['Facilities',u.facilities],['Academics',u.academics],['Fan Support',u.fan_support],['Admin Patience',u.admin_patience],['Program Ceiling',u.program_ceiling],['Rivalry',u.rivalry?(rivalOf(u)?.name||'—'):'—'],['Trophy',u.rivalry?.trophy||'—'],['All-time series',rivalrySeriesText(u)||'—'],['Season expectation',seasonExpectation(u)+' wins'],['Admin confidence',(u.adminConfidence??'—')+' · '+adminConfidenceLabel(u.adminConfidence??50)],['Mandate',u.mandate?u.mandate.text:'None'],['NIL budget',nilSummaryText(u)],['Career',careerSummaryText()]].map(x=>`<div class="lineitem"><span>${x[0]}</span><strong>${x[1]}</strong></div>`).join('')}
function applyProgramEdit(){const u=selected(),old=u.name,newName=$('#editName').value.trim()||old;if(/[<>"]/.test(newName)){alert('Program names cannot contain HTML markup or double quotes.');return}if(newName!==old&&T(newName)){alert('A program already uses that name.');return}u.name=newName;for(const [id,key] of [['editPrestige','prestige'],['editResources','resources'],['editNil','nil'],['editDevelopment','development'],['editFacilities','facilities'],['editAcademics','academics']])u[key]=clamp(parseInt($('#'+id).value||u[key],10),1,100);if(newName!==old){universe.schedule.flat().forEach(g=>{if(g.home===old)g.home=newName;if(g.away===old)g.away=newName});universe.teams.forEach(t=>t.schedule.forEach(g=>{if(g.home===old)g.home=newName;if(g.away===old)g.away=newName}));universe.recruits.forEach(r=>{if(r.leader===old)r.leader=newName;if(r.committed===old)r.committed=newName});for(const row of universe.signingDay?.board||[]){if(row.from===old)row.from=newName;if(row.challenger===old)row.challenger=newName}if(universe.recruitCycle?.signeesByTeam?.[old]!==undefined){universe.recruitCycle.signeesByTeam[newName]=universe.recruitCycle.signeesByTeam[old];delete universe.recruitCycle.signeesByTeam[old]}rebuildRecruitClassCounts();let opt=[...$('#userTeam').options].find(o=>o.value===old);if(opt){opt.value=newName;opt.textContent=newName}$('#userTeam').value=newName;rebuildIndexes()}ranked();render();setStatus('Program changes applied. Conference schedule will fully rebalance next season.')}
function renderDevelopmentResults(u,ds){const available={SPRING:ds.springReport||[],FALL:ds.fallReport||[]};if(!available[developmentResultsPhase]?.length)developmentResultsPhase=available.FALL.length?'FALL':available.SPRING.length?'SPRING':'';const report=available[developmentResultsPhase]||[];$('#developmentResults').innerHTML=developmentResultsHTML(report,u,developmentResultsFilter,developmentResultsSort);$$('[data-development-phase]').forEach(b=>{b.disabled=!available[b.dataset.developmentPhase]?.length;b.classList.toggle('active',b.dataset.developmentPhase===developmentResultsPhase);b.onclick=()=>{developmentResultsPhase=b.dataset.developmentPhase;developmentResultsFilter='ALL';renderDevelopment()}});$$('[data-development-filter]').forEach(b=>b.onclick=()=>{developmentResultsFilter=b.dataset.developmentFilter;renderDevelopment()});const sort=$('#developmentResultsSort');if(sort)sort.onchange=()=>{developmentResultsSort=sort.value;renderDevelopment()};$$('[data-development-result]').forEach(b=>b.onclick=()=>{const x=report.find(x=>x.id===b.dataset.developmentResult),p=u.roster.find(p=>p.id===b.dataset.developmentResult);$('#developmentResultDetail').innerHTML=developmentResultDetailHTML(x,p)})}
function renderDevelopment(){const u=selected(),ds=ensureDevelopmentState();ensureTeamDevelopment(u);for(const p of u.roster)ensurePlayerDevelopment(p,u);let focus=$('#teamTrainingFocus');if(focus){if(!focus.options.length)Object.keys(TEAM_TRAINING).forEach(x=>focus.add(new Option(x,x)));focus.value=u.trainingFocus;$('#trainingImpact').textContent=TEAM_TRAINING[u.trainingFocus]?.desc||''}let complete=universe.phase==='complete',os=normalizeOffseasonState();$('#runSpringCamp').disabled=!complete||os.phase!=='spring'||os.completed.includes('spring');$('#runFallCamp').disabled=!complete||os.phase!=='fall'||os.completed.includes('fall');$('#applyCampWinners').disabled=!ds.battles?.length;$('#campPhaseCard').innerHTML=complete?`<strong>${universe.year} offseason</strong><div class="compact muted">Spring development: ${ds.springRun?'complete':'not run'} · Fall camp: ${ds.fallRun?'complete':'not run'}</div>`:openingPreseason()?'<strong>Preseason setup</strong><div class="compact muted">Development priorities are editable now; camp actions unlock after the national championship.</div>':'<strong>In season</strong><div class="compact muted">Development planning is visible now; camp actions unlock after the national championship.</div>';let avgConf=Math.round(avg(u.roster.map(p=>{ensurePlayerDevelopment(p,u);return p.scoutConfidence}))),transition=u.roster.filter(p=>familiarity(p,p.pos)<80).length,young=u.roster.filter(p=>eligibilityBase(p)<=1).length;$('#developmentSummary').innerHTML=`<div class="lineitem"><span>Average scouting confidence</span><strong>${avgConf}%</strong></div><div class="lineitem"><span>Freshmen / sophomores</span><strong>${young}</strong></div><div class="lineitem"><span>Position-transition projects</span><strong>${transition}</strong></div><div class="lineitem"><span>Program development</span><strong>${grade(u.development)}</strong></div>`;renderDevelopmentResults(u,ds);
...
function setActiveSaveSlot(slot){
 ...
 titleBrowserSave=loadableSlotMeta();
...
async function storageOperation(action){
  // A user-initiated save or load always outranks a background checkpoint. Without this,
  // an autosave holding storageBusy makes the Load button silently do nothing:
  // storageOperation returns early and the player gets no feedback at all.
  await yieldToUserAction();
...
// Browser saves are generated by Dynasty Lab itself, so their hot load path only needs
...
function validateImportedSaveText(value){
  ...
  while(pending.length){
    ...
    if(typeof current==='string'){
      ...
      if(/[<>]/.test(current)||/["']\s*[A-Za-z_:][-A-Za-z0-9_:.]*\s*=/.test(current)||/javascript\s*:/i.test(current))
        throw new Error('Invalid dynasty save. Imported text contains unsafe markup.');
      continue;
    }
    if(!current||typeof current!=='object'||seen.has(current))continue;
    seen.add(current);
    for(const [key,item] of Object.entries(current)){pending.push(key);pending.push(item)}
  }
}
...
function installSave(d,state=null){
  const candidate=validateSave(d),previous=universe,previousArchive=browserArchives.get(activeSaveSlot),previousTeam=$('#userTeam').value,previousGuidanceReturn=guidanceReturnState;
  try{
    syncGameplayRng(previous);universe=candidate;ensureGameplayRng();if(!universe.mode)universe.mode=legacyControlMode(d,universe);
    ...
    normalizeUniverse();normalizeGuidanceState();normalizeOffseasonState();refreshTeamOptions(d.userTeam||universe.teams[0].name);guidancePrepareReturn(d.savedAt);render();
  }catch(e){
    universe=previous;guidanceReturnState=previousGuidanceReturn;ensureGameplayRng();if(previousArchive)browserArchives.set(activeSaveSlot,previousArchive);else browserArchives.delete(activeSaveSlot);rebuildIndexes();refreshTeamOptions(previousTeam);throw e;
  }
}
...
// coalesces a burst (simming a season fires one per week) into a single write.
const AUTOSAVE_DEBOUNCE_MS=900;
const AUTOSAVE_KINDS=['week','postseason','signing','portal','camp','preseason','guidance'];
let autosaveTimer=null,autosaveKind=null,autosaveEnabled=true,autosaveInFlight=null;
// Drops a queued checkpoint and waits out one already writing, so the caller finds the
// store free. Never rejects: a failed checkpoint must not break the action the player asked for.
async function yieldToUserAction(){
 if(typeof clearTimeout==='function')clearTimeout(autosaveTimer);
 autosaveTimer=null;autosaveKind=null;
...
function autosaveBlocked(){
 ...
 // querySelectorAll is counted rather than querySelector truth-tested: a stub or shim can
 // return an object for any selector, which would wedge autosave off permanently.
 if(typeof document!=='undefined'&&document.querySelectorAll?.('dialog[open]')?.length)return 'a dialog is open';
 return null;
}
function autosaveAfter(kind){
 if(!AUTOSAVE_KINDS.includes(kind))throw new Error(`Unknown autosave checkpoint "${kind}".`);
 autosaveKind=kind;
...
async function runAutosave(){
 ...
 if(autosaveBlocked()){autosaveKind=null;return false}
 // A manual save owns the store while it runs; come back rather than racing it.
 if(storageBusy){autosaveAfter(kind);return false}
 autosaveKind=null;storageBusy=true;
 let settle;
 ...
 try{
  ...
  // Never block play on a failed checkpoint: the dynasty in memory is still fine.
  setStatus(`Autosave failed (${e.message||'unknown error'}). Your dynasty is still open — use Save or Export.`);
  return false;
 }finally{storageBusy=false;autosaveInFlight=null;settle()}
}
...
function refreshTeamOptions(sel){$('#userTeam').innerHTML='';universe.teams.slice().sort((a,b)=>a.name.localeCompare(b.name)).forEach(s=>{let o=document.createElement('option');o.value=s.name;o.textContent=s.name;$('#userTeam').appendChild(o)});$('#userTeam').value=T(sel)?sel:universe.teams[0].name;renderControlMode()}
...
function titleCalendarStage(phase,week){if(phase==='preseason')return'Preseason';if(phase==='regular')return week?`Week ${week}`:'Week 1 ready';if(phase==='complete')return'Season complete';return'Postseason'}
function titleSummary(d){
 if(d?.program){const stage=titleCalendarStage(d.phase,d.week);return `${d.program} · ${d.year} · ${stage}${d.record?` · ${d.record}`:''}${d.approximateBytes?` · ${slotBytes(d.approximateBytes)}`:''}`}
 const u=d?.universe;if(!u||!Array.isArray(u.teams))return'';const name=d.userTeam||u.teams[0]?.name||'Unknown program',t=u.teams.find(x=>x.name===name),stage=titleCalendarStage(u.phase,u.week);return `${name} · ${u.year} · ${stage}${t?` · ${t.w}-${t.l}`:''}`;
}
...
function showTitleScreen(){
 $('#app').hidden=true;$('#dynastySetup')&&($('#dynastySetup').hidden=true);$('#titleScreen').hidden=false;document.body.classList.remove('dynasty-open','setup-open');renderTitleState();showTitlePanel();setTitleStatus(universe?'Current session is ready to resume.':slotStorageError()||(titleBrowserSave?`${storageKind()==='desktop'?'Desktop save':'Browser save'} ready ${storageLocation()}.`:'Choose New Dynasty or load a save.'));window.scrollTo?.(0,0);
}
function enterDynasty(){if(!universe)return;$('#titleScreen').hidden=true;$('#dynastySetup')&&($('#dynastySetup').hidden=true);$('#app').hidden=false;document.body.classList.remove('setup-open');document.body.classList.add('dynasty-open');render();window.scrollTo?.(0,0);$('#app .topbar')?.focus?.()}
...
function startTitleDynasty(){
 ...
 const program=$('#titleTeam').value||'Chicago Metropolitan',mode=$('#titleMode').value||'dynasty';createNewDynasty(mode);refreshTeamOptions(program);enterDynasty();setStatus(`New ${program} ${mode==='commissioner'?'commissioner universe':'dynasty'} ready for preseason setup in ${activeSlotMeta()?.label||'the selected slot'}. Save to preserve it.`);
}
...
function bind(){
 document.addEventListener('click',e=>{const b=e.target.closest('[data-game]');if(b){e.preventDefault();showGameCenter(b.dataset.game,b.dataset.gameTab||'Summary')}});
...
$$('.tabs button').forEach(b=>b.onclick=()=>{$$('.tabs button').forEach(x=>x.classList.remove('active'));$$('.tab').forEach(x=>x.classList.remove('active'));b.classList.add('active');$('#'+b.dataset.tab).classList.add('active');setActiveTab(b.dataset.tab)});
 ...
 $('#titleContinue').onclick=continueTitleDynasty;$('#titleNew').onclick=openNewDynastySetup;$('#titleLoad').onclick=()=>showTitlePanel('titleLoadPanel');$('#titleOptions').onclick=()=>showTitlePanel('titleOptionsPanel');$('#titleHowTo').onclick=()=>showTitlePanel('titleHowPanel');
...
if(typeof window!=='undefined')window.__DL_TEST__={selected,createOpening,renderStaff,setTeamScheme,schemeTransition,positionChangeWillingness,commissionerMode,renderControlMode,preseasonDebug(){return{phase:universe?.phase,week:universe?.week,played:(universe?.schedule||[]).flat().filter(g=>g.played).length,targeted:(universe?.recruits||[]).filter(r=>r.targeted).length,rng:JSON.stringify(universe?.rng||null)}},setGameplayRng(seed){activateGameplayRng(seed,universe);syncGameplayRng()},prepareDevelopmentResults(){universe.phase='complete';universe.offseason=makeOffseasonState(universe.year,'spring',['review','departures','signing','portal']);runSpringCamp()}};
if(typeof window!=='undefined')Object.assign(window.__DL_TEST__,{prepareGuidanceReturn(savedAt){guidancePrepareReturn(savedAt);renderGuidanceSystem()}});
loadSchools().then(()=>{populateTitleTeams();POS.forEach(p=>{let o=document.createElement('option');o.value=p;o.textContent=p;$('#positionFilter').appendChild(o)});[...new Set(schools.map(t=>t.conference))].forEach(c=>{let o=document.createElement('option');o.value=c;o.textContent=c;$('#editConference').appendChild(o)});bind();bindNewDynastySetup();applyTitlePreferences();showTitleScreen();refreshTitleSave().then(restoreNewDynastySetupDraft);}).catch(e=>{$('#titleStatus').textContent='Could not initialize Dynasty Lab. '+e.message});
})();
